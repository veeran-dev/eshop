...
class Footer extends React.Component{
        ...
        setTimeout(
            function() {
                if (typeof window !== `undefined`) {
                    ...
                    if(paragraph == "kobster.com/home/" || paragraph == "https://www.kobster.com/home/" || paragraph == "https://www.kobster.com/home/#"){
    ...
    render(){
        return(
            <footer className={this.state.showfooter === true ? "footer":"footer hideFooter"}>
