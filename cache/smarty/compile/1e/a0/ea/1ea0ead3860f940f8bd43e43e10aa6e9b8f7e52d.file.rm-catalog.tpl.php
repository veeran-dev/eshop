<?php /* Smarty version Smarty-3.1.19, created on 2018-10-30 18:08:36
         compiled from "rm\rm-catalog.tpl" */ ?>
<?php /*%%SmartyHeaderCode:78515bd850cc683513-03958495%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1ea0ead3860f940f8bd43e43e10aa6e9b8f7e52d' => 
    array (
      0 => 'rm\\rm-catalog.tpl',
      1 => 1518094424,
      2 => 'file',
  ...
  'nocache_hash' => '78515bd850cc683513-03958495',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bd850cce12518_31130152',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bd850cce12518_31130152')) {function content_5bd850cce12518_31130152($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp64\\www\\kobsterEshop\\tools\\smarty\\plugins\\modifier.date_format.php';
...
">
 ...
 <br /> Ref: <?php echo $_smarty_tpl->tpl_vars['product']->value['reference'];?>
							...
							<td class="date"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['product']->value['date_added'],"%b %e, %Y");?>
</td>
...
" name="id_product" class="product_id" />
								<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['product']->value['product_price'];?>
" name="product_price" class="product_price" />
								<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
