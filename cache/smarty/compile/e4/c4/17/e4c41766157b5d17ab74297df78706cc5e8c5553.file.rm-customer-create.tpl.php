<?php /* Smarty version Smarty-3.1.19, created on 2017-12-01 17:32:44
         compiled from "rm\rm-customer-create.tpl" */ ?>
<?php /*%%SmartyHeaderCode:129605a2144e4ecbe05-11046741%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4c41766157b5d17ab74297df78706cc5e8c5553' => 
    array (
      0 => 'rm\\rm-customer-create.tpl',
      1 => 1512129735,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '129605a2144e4ecbe05-11046741',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a2144e52d8595_02733414',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a2144e52d8595_02733414')) {function content_5a2144e52d8595_02733414($_smarty_tpl) {?><script type="text/javascript" src="rm/js/rm-customer-configure.js"></script>
...
?>
                                    <?php if ($_smarty_tpl->tpl_vars['group_name']->value[0]['id_group']==$_smarty_tpl->tpl_vars['data']->value['id_group']) {?>
...
">
                              ...
                              <?php if ($_smarty_tpl->tpl_vars['group_name']->value[0]['id_group']) {?>
                              <!-- <div class="panel"> -->
                           </div>
                           <?php }?>
                        </form>
                  ...
                  <div class="panel-body">
                     <table class="table table-bordered" id="group_customers">
                        ...
                        <tbody>
                           ...
                           <?php  $_smarty_tpl->tpl_vars['data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['data']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['group_customers']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['data']->key => $_smarty_tpl->tpl_vars['data']->value) {
$_smarty_tpl->tpl_vars['data']->_loop = true;
?>
                           <tr>
                              ...
                              <td>
                                 <a href="#" title="Remove customer from group" 
                                    onclick="removeCusGroup(<?php echo $_smarty_tpl->tpl_vars['data']->value['id_customer'];?>
,<?php echo $_smarty_tpl->tpl_vars['group_name']->value[0]['id_group'];?>
,0)">
                                    <div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form role="form" id="customer-edit-form"  >
               ...
               <input type="hidden" name="id_employee" id="employee_id" value="<?php echo $_smarty_tpl->tpl_vars['cookie']->value->id_employee;?>
">
         ...
         <div class="modal-body position-center">
            ...
            <div class="form-group">
               <select onchange="setRm();" id="group_select_5" class="populate placeholder select2-offscreen form-control" tabindex="-1" title="" name="group_id" onchange="" required>
                  ...
                  <?php  $_smarty_tpl->tpl_vars['data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['data']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['kam']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['data']->key => $_smarty_tpl->tpl_vars['data']->value) {
$_smarty_tpl->tpl_vars['data']->_loop = true;
?>
                     <option value="<?php echo $_smarty_tpl->tpl_vars['data']->value['id_employee'];?>
">
                        <?php echo $_smarty_tpl->tpl_vars['data']->value['firstname'];?>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body position-center">
            <div class="form-group">
               ...
               <select id="group_select_6" class="populate placeholder select2-offscreen form-control" tabindex="-1" title="" name="group_id" onchange="" required>
                  <option value="">Select Company</option>
                  <?php  $_smarty_tpl->tpl_vars['data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['data']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['groups']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['data']->key => $_smarty_tpl->tpl_vars['data']->value) {
