<?php /* Smarty version Smarty-3.1.19, created on 2017-10-03 15:56:45
         compiled from "scn\scn-orders.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1125359d365e5b89701-39883233%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd51a2cac6af47cb79705764986a1255dc1889e51' => 
    array (
  ...
  'nocache_hash' => '1125359d365e5b89701-39883233',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59d365e6bf2e79_16950212',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59d365e6bf2e79_16950212')) {function content_59d365e6bf2e79_16950212($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp\\www\\kobsterEshop\\tools\\smarty\\plugins\\modifier.date_format.php';
...
" title="Download Customer PO" download class="text-success">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <strong>
                                                        <?php echo Tools::displayPrice($_smarty_tpl->tpl_vars['order']->value->getTotalProductsWithTaxes(),$_smarty_tpl->tpl_vars['currency']->value,false);?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <strong>
                                                        <?php echo Tools::displayPrice($_smarty_tpl->tpl_vars['order']->value->total_wrapping,$_smarty_tpl->tpl_vars['currency']->value,false);?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <strong>
                                                        <?php echo Tools::displayPrice($_smarty_tpl->tpl_vars['order']->value->total_shipping,$_smarty_tpl->tpl_vars['currency']->value,false);?>
...
').slideToggle();">Generate DR</button>
                                                ...
                                                <?php if (!$_smarty_tpl->tpl_vars['order']->value->hasBeenShipped()&&!$_smarty_tpl->tpl_vars['order']->value->hasBeenPartiallyShipped()&&!$_smarty_tpl->tpl_vars['order']->value->packedandreadytobeshipped()&&$_smarty_tpl->tpl_vars['order']->value->total_discounts==0) {?>
                                                    <button type="button" class="btn btn-sm btn-primary prod-action-btn-danger <?php if (count($_smarty_tpl->tpl_vars['product_detail']->value)==1&&$_smarty_tpl->tpl_vars['product_detail']->value[0]['product_quantity_true']==1) {?>hidden<?php }?>" onclick="confirmSplit(1,<?php echo $_smarty_tpl->tpl_vars['order_id']->value;?>
,'<?php echo $_smarty_tpl->tpl_vars['orderBy']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['orderWay']->value;?>
',1, <?php echo $_smarty_tpl->tpl_vars['page']->value;?>
)">Split Order</button>
                            ...
                            <div class="col-md-6 m-bot20">
                                ...
                                <div class="panel-body panel scn-invoice-grid">
                                    ...
                                    <h5 class="text-center">
			                            <a href="kobster_admin/index.php?controller=AdminPdf&token=<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
&submitAction=generateConsolidatedInvoicePdf<?php echo $_smarty_tpl->tpl_vars['consolidated_invoice']->value;?>
" download>
			                                #<?php echo $_smarty_tpl->tpl_vars['invoice_number']->value;?>
