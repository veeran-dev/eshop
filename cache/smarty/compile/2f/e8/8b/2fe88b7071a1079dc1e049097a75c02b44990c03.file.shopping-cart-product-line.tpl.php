<?php /* Smarty version Smarty-3.1.19, created on 2017-11-29 11:14:49
         compiled from "C:\wamp\www\kobsterEshop\themes\default-bootstrap\shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:78565a1e49518a0047-47731250%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2fe88b7071a1079dc1e049097a75c02b44990c03' => 
    array (
      0 => 'C:\\wamp\\www\\kobsterEshop\\themes\\default-bootstrap\\shopping-cart-product-line.tpl',
      1 => 1502367288,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '78565a1e49518a0047-47731250',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a1e4952144022_10541671',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a1e4952144022_10541671')) {function content_5a1e4952144022_10541671($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\kobsterEshop\\tools\\smarty\\plugins\\modifier.replace.php';
...
"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'medium'), ENT_QUOTES, 'UTF-8', true);?>
...
">
		<ul class="price text-left" id="product_price_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
...
_<?php if ($_smarty_tpl->tpl_vars['quantityDisplayed']->value>0) {?>nocustom<?php } else { ?>0<?php }?>_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
_hidden" />
				<input size="2" type="text" autocomplete="off" class="cart_quantity_input grey quantity_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
_<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product_attribute'];?>
_<?php if ($_smarty_tpl->tpl_vars['quantityDisplayed']->value>0) {?>nocustom<?php } else { ?>0<?php }?>_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
...
<?php $_tmp24=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&amp;id_product=".$_tmp22."&amp;ipa=".$_tmp23."&amp;id_address_delivery=".$_tmp24."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
"><span>&nbsp;</span></i></a>
			</div>
		<?php } else { ?>
