<?php /* Smarty version Smarty-3.1.19, created on 2019-08-06 00:05:47
         compiled from "C:\wamp64\www\kobsterEshop\themes\default-bootstrap\pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:108945d48770328da50-78267812%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c376afa692a831509ced1b8dce68861dcccb0e3c' => 
    array (
      0 => 'C:\\wamp64\\www\\kobsterEshop\\themes\\default-bootstrap\\pagination.tpl',
      1 => 1478085923,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '108945d48770328da50-78267812',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d4877040a47a4_15977768',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d4877040a47a4_15977768')) {function content_5d4877040a47a4_15977768($_smarty_tpl) {?>
...
<?php }?>" class="pagination clearfix">
	    <?php if ($_smarty_tpl->tpl_vars['nb_products']->value>$_smarty_tpl->tpl_vars['products_per_page']->value&&$_smarty_tpl->tpl_vars['start']->value!=$_smarty_tpl->tpl_vars['stop']->value) {?>
			<form class="showall <?php if ($_smarty_tpl->tpl_vars['nb_products']->value>200) {?>hidden<?php } else { ?><?php }?>" action="<?php if (!is_array($_smarty_tpl->tpl_vars['requestNb']->value)) {?><?php echo $_smarty_tpl->tpl_vars['requestNb']->value;?>
...
" rel="prev"><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
...
<?php }?>" class="disabled pagination_previous">
						<span><?php echo smartyTranslate(array('s'=>'Previous'),$_smarty_tpl);?>
</span>
					</li>
				<?php }?>
...
" rel="next"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
</i>
						</a>
					</li>
				<?php } else { ?>
