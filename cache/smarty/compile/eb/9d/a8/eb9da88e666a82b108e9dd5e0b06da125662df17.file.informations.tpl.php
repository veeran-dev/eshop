<?php /* Smarty version Smarty-3.1.19, created on 2020-05-30 12:30:22
         compiled from "C:\wamp64\www\kobsterEshop\kobster_admin\themes\default\template\controllers\products\informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:128155ed2048635ec26-76090309%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb9da88e666a82b108e9dd5e0b06da125662df17' => 
    array (
      0 => 'C:\\wamp64\\www\\kobsterEshop\\kobster_admin\\themes\\default\\template\\controllers\\products\\informations.tpl',
      1 => 1510813303,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '128155ed2048635ec26-76090309',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ed20486ac8eb8_58375258',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ed20486ac8eb8_58375258')) {function content_5ed20486ac8eb8_58375258($_smarty_tpl) {?>
...
" />
	...
	<div class="form-group">
		<label class="control-label col-lg-3 required" for="hsnCode">
			<span class="label-tooltip" data-toggle="tooltip"
				title="<?php echo smartyTranslate(array('s'=>'The unique identification code to find type of product. This is for GST purpose.'),$_smarty_tpl);?>
">
				<?php echo $_smarty_tpl->tpl_vars['bullet_common_field']->value;?>
 <?php echo smartyTranslate(array('s'=>'HSN Code'),$_smarty_tpl);?>

			</span>
		</label>
		<div class="col-lg-3">
			<input maxlength="8" minlength="4" type="text" id="hsnCode" name="hsn_code" value="<?php echo smarty_modifier_htmlentitiesUTF8($_smarty_tpl->tpl_vars['product']->value->hsn_code);?>
" />
		</div>
	</div>
				...
				<div class="col-lg-9">
					...
					<div class="checkbox">
						<label for="discontinued">
							<input type="checkbox" name="discontinued" id="discontinued" value="1" <?php if ($_smarty_tpl->tpl_vars['product']->value->discontinued) {?>checked="checked"<?php }?> >
							<?php echo smartyTranslate(array('s'=>'Discontinued'),$_smarty_tpl);?>
</label>
					</div>
					<div class="checkbox">
...
<div id="product_options" class="form-group">
	...
	<div class="form-group">
		...
		<label class="control-label col-lg-2 " for="available_for_order">
			<?php echo smartyTranslate(array('s'=>'Zones '),$_smarty_tpl);?>

		</label>
		<div class="col-lg-9">
			<div class="checkbox">
				<label for="zone">
					<input type="checkbox" class="zone" name="zone[]" id="zone[]" value="0" <?php if ($_smarty_tpl->tpl_vars['available_across_india']->value==1) {?>checked="checked"<?php }?> >PAN India</label>
			</div>
...
?>
				<div class="checkbox">
					<label for="zone">
						<input type="checkbox" class="zone" name="zone[]" id="zone[]" value="<?php echo $_smarty_tpl->tpl_vars['zone']->value['id_fulfillment_centre'];?>
" <?php if ($_smarty_tpl->tpl_vars['zone']->value['available']) {?>checked="checked"<?php }?> >
						<?php echo $_smarty_tpl->tpl_vars['zone']->value['city_name'];?>
</label>
				</div>
			<?php } ?>
		</div>
