<script type="text/javascript" src="scn/js/scn-quotation.js"></script>
            ...
            <div class="col-md-12 panel">
                ...
                <div class="col-xs-12 col-md-12 display-none" id="view-cus-prices">
                    ...
                    <table class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                <th colspan="5" class="text-center">Buying Price in Regions (Tax Exclusive) <i class="fa fa-question-circle text-primary" title="The lowest agreed buying price from the manufacturer region wise." aria-hidden="true"></i></th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="col-sm-12">
            <section class="panel panel-quote-revise">
                <header class="panel">
                    ...
                    <center id='revise-quote-name'></center>
