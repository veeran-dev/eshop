<script src="scn/js/scn-vendorbill.js"></script>
<div class="panel">
          ...
          <section class="panel-body" id="vendor_bill">
             ...
             <!--<div class="col-lg-8">
                ...
                <div class="col-sm-12">
                   ...
                   <div class="col-lg-2"><input type="button" class="btn btn-primary col-lg-12 billPart" id="billdetails" value="Save" onclick="saveBill();" /></div>
               </div>
           </div> 
         </div>
