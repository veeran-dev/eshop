...
export default class InputFieldOverlay extends Component {
  ...
  handleDayClick(e, day) {
    ...
    if(this.props.dateState.returnDate != "") {
      var returnDateObj = new Date(this.props.dateState.returnDate);
      var returnDate = new Date(returnDateObj.getFullYear(), returnDateObj.getMonth()+1, returnDateObj.getDate());
      if(oldDate > returnDate) {
