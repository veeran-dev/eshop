      ...
      <div className="notifications">
        <div className="page-header">
          <button className="back" onClick={this.context.router.goBack.bind(this)}>
					...
					<div className="action-block"><Ripples><button className="button-red outline" onClick={G.openRequestQuote.bind(this, null, null)}>Request Quote</button></Ripples></div>
				</div>
