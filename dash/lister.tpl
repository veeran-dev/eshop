...
<head>
    ...
    <meta name="description" content="Lister Technologies - Kobster.com Business">
    <meta name="author" content="Kobster.com">
    <link rel="shortcut icon" href="{$img_ps_dir}favicon.ico">
	

    <title>Lister Technologies - Home Screen - Kobster.com</title>
...
<body class="lock-screen" onload="startTime()">
    ...
    <div class="lock-wrapper">
        ...
        <div class="lock-box text-center">
            <div class="lock-name">Jayashree S</div>
            <img src="dash/images/face/18.jpg" alt="lock avatar"/>
            <div class="lock-pwd">
                <form id="dash_login_form" role="form" class="form-inline" method="POST" action="{$link->getPageLink('dash-login.php')}">
                    <div class="form-group">
						<input type="hidden" id="login_email" name="login_email" value="jayashree.srinivasan@listertechnologies.com"/>
