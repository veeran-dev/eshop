...
<head>
    ...
    <meta name="description" content="Airbus Group India Private Limited - Kobster.com Business">
    <meta name="author" content="Kobster.com">
    <link rel="shortcut icon" href="{$img_ps_dir}favicon.ico">
	

    <title>Airbus Group India Private Limited - Home Screen - Kobster.com</title>
...
<body class="lock-screen" onload="startTime()">
    ...
    <div class="lock-wrapper">
        ...
        <div class="lock-box text-center">
            <div class="lock-name"></div>
            <img src="dash/images/face/50.png" alt="lock avatar"/>
            <div class="lock-pwd">
