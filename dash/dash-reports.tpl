	...
	<div class="col-xs-12 col-md-6">
		 <div class="btn-group selectlist">
		  <button class="btn btn-primary buttonColor dropdown-toggle padding" type="button" data-toggle="dropdown">
			<span id="listTitle">Select a User</span><span class="caret cust_caret"></span>
		  </button>
...
<div id="pick-customer" class="row" style="display:none">
	<section class="panel-body">
		<header class="rm_heading">Reports</header>
 			...
 			<div class="">
				<div class="">
					...
					<div class="form-group col-md-7 col-sm-7 col-xs-7 col-lg-7">
                            <div class="select2-container populate placeholder js-example-basic-single js-states form-control select2-hidden-accessible" id="s2id_e2">
                            	<a href="javascript:void(0)" onclick="return false;" class="select2-choice" tabindex="-1">   
                            		<span class="select2-chosen" id="select2-chosen-3">Select User</span>
                            		<abbr class="select2-search-choice-close"></abbr>
                            		<span class="select2-arrow" role="presentation">
                            			<b role="presentation"></b>
                            		</span>
  ...
  <div class="col-sm-11 ">
    ...
    <div id="categories_report" style="display:none; height:420px;">
      <section class="panel">
		...
		<div style="display:none;" id="chartContainer_1"></div> 
		 ...
		 <div style="display:none;" id="chartContainer_6"></div> 
    ...
    <div id="topproducts_report" style="display:none;height:420px;">
      <section class="panel">
		...
		<div style="display:none;" id="barChartContainer_6"></div> 
      </section>
    </div>
    <div id="locationBasedReport_div" style="display:none;height:420px;">
      <section class="panel">
		...
		<div style="display:none;" id="locationBasedReport_6"></div>
      </section>
    </div>
	<div id="top_10_product_in_cate_div" style="display:none;height:420px;">
      <section class="panel">
		...
		<div style="display:none;" id="top_10_product_in_cate_6"></div>
      </section>
    </div>
  </div>
</div>
...
<div class="row">
    <div class="col-sm-11">
		...
		<section style="display:none;"  class="repo_filter col-sm-3">
			<div class="panel-body">
				<select id="orderid" onchange="durationReport(0,0);" class="form-control kob_clear_date">
		...
		<section style="display:none;"  class="repoCategoryFilter col-sm-3">
 		...
 		<section class="col-sm-9">
			<div class="panel-body staticButtons">
				<button class="btn btn-danger kob_button kob_clear_date" onclick="durationReport(4,0);" type="button">All</button>
 
				<!-- <button class="btn btn-danger kob_button" onclick="durationReport(6,0);" type="button">Current Month</button> -->
 				<button class="btn btn-danger kob_button kob_clear_date" onclick="durationReport(1,0);" type="button">Last 3 Months</button>
				<button class="btn btn-danger kob_button kob_clear_date" onclick="durationReport(2,0);" type="button">Last 6 Months</button>
				<button class="btn btn-danger kob_button kob_clear_date" onclick="durationReport(3,0);" type="button">Last 1 Year</button>
				<button class="btn btn-primary" id="pdfclick" onclick="exportReport();" type="button">Export as PDF</button>
			</div>
			<div class="col-md-8 col-xs-8 col-lg-8 col-sm-8 date-range-block">
				<div data-date-format="mm/dd/yyyy" data-date="13/07/2013" class="input-group input-large">
					<span class="input-group-addon">From</span>
					<input type="text" name="from_date" class="form-control dpd1 from_date_elite">
					<span class="input-group-addon">To</span>
					<input type="text" name="to_date" class="form-control dpd2 to_date_elite">
				</div>
				<span class="help-block">Select date range</span>
			</div>
			<button class="btn btn-danger kob_button date-range-block" onclick="durationReport(6,0);" type="button">Filter</button>
		</section>
    </div>
</div>
