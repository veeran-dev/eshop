...
<head>
    ...
    <meta name="description" content="Gravitas Technology Services - Kobster.com Business">
    ...
    <title>Gravitas Technology Services - Home Screen - Kobster.com</title>
    ...
    <div class="lock-wrapper">
         ...
         <div class="lock-box text-center">
			<form id="dash_login_form" role="form" class="form-inline" method="POST" action="{$link->getPageLink('dash-login.php')}">
				...
				<img src="dash/images/face/89.png" alt="lock avatar"/>
				<div class="lock-pwd">
