...
<head>
    ...
    <meta name="description" content="Mosambee - Kobster.com Business">
    ...
    <title>Mosambee - Home Screen - Kobster.com</title>
    ...
    <div class="lock-wrapper">
         ...
         <div class="lock-box text-center">
			<form id="dash_login_form" role="form" class="form-inline" method="POST" action="{$link->getPageLink('dash-login.php')}">
				...
				<img src="dash/images/face/99.png" alt="lock avatar"/>
				<div class="lock-pwd">
