...
<head>
    ...
    <meta name="description" content="Microchip Technologies - Kobster.com Business">
    <meta name="author" content="Kobster.com">
    <link rel="shortcut icon" href="{$img_ps_dir}favicon.ico">
	

    <title>Microchip Technologies - Home Screen - Kobster.com</title>
    ...
    <div class="lock-wrapper">
        ...
        <div class="lock-box text-center">
			<form id="dash_login_form" role="form" class="form-inline" method="POST" action="{$link->getPageLink('dash-login.php')}">
				<input autofocus type="text" class="form-control lock-name" id="login_email" placeholder="Email" name="login_email" value=""/>
				<img src="dash/images/face/11.jpg" alt="lock avatar"/>
				<div class="lock-pwd">
					<div class="form-group">
						<input autofocus type="password" name="login_passwd" id="login_passwd" placeholder="Password" class="form-control lock-input">
