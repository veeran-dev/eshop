/*
 CanvasJS HTML5 & JavaScript Charts - v1.5.0 Beta 3 - http://canvasjs.com/ 
...
(function() {
    ...
    function w(a, b, c) {
        ...
        (this._container = "string" === typeof this._containerId ? document.getElementById(this._containerId) :
            ...
            this._canvasJSContainer.style.position = "relative", this._canvasJSContainer.style.textAlign = "left", this._canvasJSContainer.style.cursor = "auto", v || (this._canvasJSContainer.style.height = "0px"), this._container.appendChild(this._canvasJSContainer), this.canvas = da(a, b), this.canvas.style.position = "absolute", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Aa(this.ctx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas =
                da(a, b), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")), this.overlaidCanvas = da(a, b), this.overlaidCanvas.style.position = "absolute", this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline = "top", this._eventManager = new Y(this), F(window,
                "resize",
                function() {
                ...
                this._creditLink.setAttribute("tabIndex", -1), this._creditLink.setAttribute("target", "_blank")), this._toolTip = new M(this, this._options.toolTip, this.theme), this.layoutManager = new Z(this), this.axisY2 = this.axisY = this.axisX = this.data = null, this.renderCount = 0, this.sessionVariables = {
                axisX: {
    ...
    function H(a, b) {
        ...
        this._lineHeight = aa(this.fontFamily, this.fontSize, this.fontWeight)
    }

    function $(a, b) {
        $.parent.constructor.call(this, "Title", b, a.theme);
        this.chart = a;
    ...
    function fa(a, b, c) {
        fa.parent.constructor.call(this, "Legend", b, c);
        this.chart =
            a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
        ...
        "undefined" === typeof this._options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize));
        this.lineHeight = aa(this.fontFamily, this.fontSize, this.fontWeight)
    }
    ...
    function z(a, b, c, d) {
        ...
        "axisX" === c ? (this.sessionVariables = this.chart.sessionVariables[c], this._options.interval || (this.intervalType = null)) :
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)
            for (this.stripLines = [], b = 0; b < this._options.stripLines.length; b++) this.stripLines.push(new ka(this.chart, this._options.stripLines[b], a.theme, ++this.chart._eventManager.lastObjectId));
    ...
    function ka(a, b, c, d) {
        ...
        this.id = d;
        null !== this.startValue && null !== this.endValue && (this.value = ((this.startValue.getTime ? this.startValue.getTime() :
            this.startValue) + (this.endValue.getTime ? this.endValue.getTime() : this.endValue)) / 2, this.thickness = Math.max(this.endValue - this.startValue), this._thicknessType = "value")
    }
    ...
    function Y(a) {
        ...
        this.ghostCanvas = da(this.chart.width, this.chart.height);
    ...
    function wa(a, b) {
        var c;
        b && la[b] && (c = la[b]);
        $.parent.constructor.call(this, "CultureInfo", c, a.theme);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx
    }
        ...
        ga = function(a, b, c) {
            ...
            for (var u = 0; l && u < l.length; u++)
                if (b = l[u], "." === b && 0 > p) p = u;
                    ...
                    0 > p ? (h.push(b), "#" === b || "0" === b ? n++ : "," === b && r++) : (k.push(b), "#" !== b &&
                        "0" !== b || m++)
                }
            ...
            for (u = q = l = m = p = 0; 0 < h.length;)
                if (b = h.pop(), "#" === b || "0" === b)
                    if (p++, p === n) {
                        ...
                        d && (c = "-" + c)
                    } else 0 < g.length ? (c = g.pop() + c, m++, u++) : "0" === b && (c = "0" + c, m++, u++), 0 === u % q &&
                        (l === r && 0 < g.length) && (c = f + c);
            ...
            d = "";
            for (f = !1; 0 < k.length;) b = k.shift(), "#" === b || "0" === b ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), f = !0) : "0" === b && (d += "0", f = !0) :
                1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? d += b.slice(1, b.length - 1) : "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || !/[eE][+-]*[0]+/.test(b) ? d += b : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), d += b.replace(/[0]+/, function(a) {
                    return J(s, a.length)
                }));
            return c + ((f ? e : "") + d)
        },
    ...
    w.prototype._updateSize = function() {
        ...
        return this.canvas.width !== a * Q || this.canvas.height !== b * Q ? (ba(this.canvas, a, b), ba(this.overlaidCanvas, a, b), ba(this._eventManager.ghostCanvas, a, b), !0) : !1
    };
    ...
    w.prototype.render = function(a) {
        ...
        this._processData();
        this._options.title && (this._title = new $(this, this._options.title), this._title.render());
        this.legend = new fa(this, this._options.legend, this.theme);
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                var l = this.data[a.dataSeriesIndexes[g]],
                    ...
                    h = !1,
                    k = !1;
                if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement) var n = this.sessionVariables.axisX.internalMinimum ?
                ...
                for (p = 0; p < l.dataPoints.length; p++) {
                    "undefined" === typeof l.dataPoints[p].x && (l.dataPoints[p].x = p);
                    l.dataPoints[p].x.getTime ?
                        (f = !0, d = l.dataPoints[p].x.getTime()) : d = l.dataPoints[p].x;
                    e = l.dataPoints[p].y;
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
                    e < b.min && (b.min = e);
                    ...
                    if (!(d < n) || h) {
                        ...
                        null !== e && (e < b.viewPortMin && (b.viewPortMin =
                            e), e > b.viewPortMax && (b.viewPortMax = e))
                    }
                }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], l = [], p = 0; p < a.dataSeriesIndexes.length; p++) {
                var h = this.data[a.dataSeriesIndexes[p]],
                    ...
                    n = !1,
                    m = !1;
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var r = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum :
                ...
                for (k = 0; k < h.dataPoints.length; k++) {
                    ...
                    h.dataPoints[k].x.getTime ? (f = !0, d = h.dataPoints[k].x.getTime()) :
                        d = h.dataPoints[k].x;
                    e = h.dataPoints[k].y;
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
            ...
            for (k in g) isNaN(k) ||
                (a = g[k], a < b.min && (b.min = a), a > b.max && (b.max = a), k < c.viewPortMin || k > c.viewPortMax || (a < b.viewPortMin && (b.viewPortMin = a), a > b.viewPortMax && (b.viewPortMax = a)));
    ...
    w.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = !1, l = !1,
                    p = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement) var q = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                    s = this.sessionVariables.axisX.internalMaximum ? this.sessionVariables.axisX.internalMaximum : this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum :
                    Infinity;
                ...
                for (n = 0; n < k.dataPoints.length; n++) {
                    ...
                    if (!(d < q) || m) {
                        ...
                        k.dataPoints[n].label &&
                            (a.axisX.labels[d] = k.dataPoints[n].label);
                        d < c.viewPortMin && (c.viewPortMin = d);
                        d > c.viewPortMax && (c.viewPortMax = d);
                        null !== e && (0 <= e ? g = !0 : l = !0, p[d] = p[d] ? p[d] + Math.abs(e) : Math.abs(e))
                    }
                }
    ...
    w.prototype._processMultiYPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo,
                    c = a.axisX.dataInfo, d, e, f, g, l = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var h = this.data[a.dataSeriesIndexes[p]],
                    k = 0,
                    n = !1,
                    m = !1;
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var r = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                    q = this.sessionVariables.axisX.internalMaximum ? this.sessionVariables.axisX.internalMaximum : this._options.axisX && this._options.axisX.maximum ?
                    this._options.axisX.maximum : Infinity;
                ...
                for (k = 0; k < h.dataPoints.length; k++) {
                    ...
                    (e = h.dataPoints[k].y) && e.length && (f = Math.min.apply(null, e), g = Math.max.apply(null, e));
                    d < c.min && (c.min = d);
                    d > c.max && (c.max = d);
                    f < b.min && (b.min = f);
                    g > b.max && (b.max = g);
    ...
    w.prototype.getDataPointAtXY = function(a, b, c) {
        c = c || !1;
        for (var d = [], e = this._dataInRenderedOrder.length -
                1; 0 <= e; e--) {
            var f = null;
        ...
        for (c = 0; c < d.length; c++) b && "line" !== d[c].dataSeries.type && "stepLine" !== d[c].dataSeries.type && "area" !== d[c].dataSeries.type && "stepArea" !== d[c].dataSeries.type ||
    ...
    w.prototype.resetOverlayedCanvas =
        function() {
    ...
    w.prototype._mouseEventHandler =
        function(a) {
            if (this.interactivityEnabled) {
                ...
                if (!e) {
                    if (w.capturedEventParam) d = w.capturedEventParam, "mouseup" === c && (w.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup", d.chart._mouseEventHandler, !1)), d.hasOwnProperty(c) && d[c].call(d.context, b.x, b.y);
                        ...
                        for (e = 0; e < this._events.length; e++)
                            if (this._events[e].hasOwnProperty(c)) {
                                ...
                                if (b.x >= f.x1 && b.x <= f.x2 && b.y >= f.y1 && b.y <= f.y2) {
                                    ...
                                    "mousedown" === c && !0 === d.capture ? (w.capturedEventParam = d, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.body.addEventListener("mouseup", this._mouseEventHandler, !1)) : "mouseup" === c && (d.chart.overlaidCanvas.releaseCapture ?
    ...
    w.prototype._plotAreaMouseUp = function(a, b) {
        ...
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (2 < Math.abs(e)) {
                if (this.panEnabled) e = !1, d = 0, this.axisX.sessionVariables.internalMinimum < this.axisX._absoluteMinimum ?
    ...
    w.prototype._plotAreaMouseMove = function(a, b) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            "xySwapped" === this.plotInfo.axisPlacement ? (c = b - this.dragStartPoint.y, d = Math.abs(this.axisX.maximum - this.axisX.minimum) /
                d.height * c) : (c = this.dragStartPoint.x - a, d = Math.abs(this.axisX.maximum - this.axisX.minimum) / d.width * c);
    ...
    w.prototype.preparePlotArea = function() {
        ...
        this.axisX && b ? (a.x1 = this.axisX.lineCoordinates.x1 < this.axisX.lineCoordinates.x2 ?
    ...
    w.prototype.renderIndexLabels = function() {
        ...
        for (var b = this.plotArea, c = 0; c < this._indexLabels.length; c++) {
            ...
            var l = this.replaceKeywordsWithValue(R("indexLabel", d.dataPoint, d.dataSeries), d.dataPoint, d.dataSeries, null, d.indexKeyword),
                ...
                u = 0,
                t = d.direction;
            d.point.x < b.x1 || (d.point.x > b.x2 || d.point.y <
                        ...
                        for (var r = !1, k = 0; k < l.length; k++)
                            if (n = l[k].x.getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                                if ("number" !== typeof l[k].y) 0 < k && (b.stroke(), v && c.stroke()), r = !0;
                                    ...
                                    m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                                        (l[k].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
    ...
    w.prototype.renderStepLine = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < l.length) {
                    for (var r = !1, k = 0; k < l.length; k++)
                        if (n = l[k].getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin ||
        ...
        function b(a) {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0; b < a.length - 3; b += 3) c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), v && d.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), 0 < b && 0 === b % 3E3 && (c.stroke(),
                    c.beginPath(), c.moveTo(a[b + 3].x, a[b + 3].y), v && (d.stroke(), d.beginPath(), d.moveTo(a[b + 3].x, a[b + 3].y)));
                c.stroke();
                v && d.stroke()
            }
        }
                    ...
                    for (k = 0; k < p.length; k++)
                        if (n = p[k].getTime ? p[k].x.getTime() : p[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof p[k].y) 0 < k && (b(r), r = []);
                                ...
                                n = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (n - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                m = a.axisY.conversionParameters.reference +
                                    a.axisY.conversionParameters.pixelPerUnit * (p[k].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                ...
                                }(p[k].indexLabel || l.indexLabel) && this._indexLabels.push({
                                    chartType: "spline",
                                    dataPoint: p[k],
                                    dataSeries: l,
                                    point: {
    ...
    var D = function(a, b, c, d, e, f, g, l, p, h, k, n, m) {
        ...
        !0 === h && (a.save(), a.beginPath(), a.moveTo(b, e), a.lineTo(b + r, e - r), a.lineTo(d - r, e - r), a.lineTo(d, e), a.closePath(), g = a.createLinearGradient((d + b) / 2, e - r, (d + b) / 2, e), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(),
            a.restore());
        ...
        !0 === n && (a.save(), a.beginPath(), a.moveTo(d, c), a.lineTo(d - r, c + r), a.lineTo(d - r, e - r), a.lineTo(d, e), g = a.createLinearGradient(d - r, (e + c) / 2, d, (e + c) / 2), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = g, g.addColorStop(0,
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < m.length)
                    for (var r = 5 < k && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)
                        if (m[e].getTime ? l = m[e].x.getTime() :
                            l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
    ...
    w.prototype.renderStackedColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = 0.15 * this.width << 0,
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.plotUnits.length) <<
                0;
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < r.length) {
                    ...
                    for (g = 0; g < r.length; g++)
                        if (c = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(c < a.axisX.dataInfo.viewPortMin ||
                                c > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[g].y) {
                            ...
                            c = r[g].color ?
                                r[g].color : m._colorSet[g % m._colorSet.length];
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < r.length)
                    for (var q = 5 < k && m.bevelEnabled ? !0 : !1, g = 0; g < r.length; g++)
                        if (c = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) &&
                            "number" === typeof r[g].y) {
                            d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (c - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            if (0 <= r[g].y) {
                                ...
                                t = p - x;
                                e[c] = x + (t - l)
                            } else x = f[c] ? f[c] : 0, t = l + x, l = p + x, f[c] =
                                x + (t - l);
    ...
    w.prototype.renderBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 *
                (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.totalDataSeries) << 0;
            k > e ? k = e : Infinity === h ? k = e : 1 > k && (k = 1);
            b.save();
            v && this._eventManager.ghostCtx.save();
            b.beginPath();
    ...
    w.prototype.renderStackedBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = 0.15 * this.width << 0,
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 * (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.plotUnits.length) <<
                0;
            k > g ? k = g : Infinity === h ? k = g : 1 > k && (k = 1);
            b.save();
            v && this._eventManager.ghostCtx.save();
    ...
    w.prototype.renderStackedBar100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = 0.15 * this.width << 0,
                h = a.axisX.dataInfo.minDiff,
                k = 0.9 * (d.height / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(h) / a.plotType.plotUnits.length) << 0;
            k > g ? k = g : Infinity === h ? k = g : 1 > k && (k =
                1);
            b.save();
            v && this._eventManager.ghostCtx.save();
            b.beginPath();
                    ...
                    for (var V = !0; m < k.length; m++)
                        if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[m].y) b(), V = !0;
                                ...
                                0 !== k[m].markerSize && (0 < k[m].markerSize || 0 < h.markerSize) &&
                                    (s = h.getMarkerProperties(m, r, q, c), g.push(s), B = A(B), v && g.push({
                                        x: r,
                                        y: q,
                                        ctx: d,
                                        type: s.type,
    ...
    w.prototype.renderSplineArea = function(a) {
        function b() {
            ...
            if (0 < b.length) {
                ...
                c.fill();
                c.globalAlpha = 1;
                v && (d.lineTo(b[b.length -
                    1].x, s), d.lineTo(u.x, s), d.closePath(), d.fill())
            }
        }
        var c = this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (c.lineWidth = h.lineThickness; n < k.length; n++)
                        if (m = k[n].x.getTime ? k[n].x.getTime() : k[n].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof k[n].y) 0 < n && (b(), t = []);
                                ...
                                m =
                                    a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (m - a.axisX.conversionParameters.minimum) + 0.5 << 0;
    ...
    w.prototype.renderStepArea = function(a) {
        function b() {
            x && (0 < h.lineThickness && c.stroke(), 0 >= a.axisY.minimum && 0 <= a.axisY.maximum ? t = u : 0 >
                a.axisY.maximum ? t = f.y1 : 0 < a.axisY.minimum && (t = e.y2), c.lineTo(r, t), c.lineTo(x.x, t), c.closePath(), c.globalAlpha = h.fillOpacity, c.fill(), c.globalAlpha = 1, v && (d.lineTo(r, t), d.lineTo(x.x, t), d.closePath(), d.fill()), c.beginPath(), c.moveTo(r, q), d.beginPath(), d.moveTo(r, q), x = {
                    x: r,
                    y: q
                })
        }
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < k.length) {
                    ...
                    for (c.lineWidth = h.lineThickness; m < k.length; m++)
                        if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                            var B = q;
                            "number" !== typeof k[m].y ? (b(), E = !0) : (r = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (s - a.axisX.conversionParameters.minimum) + 0.5 << 0, q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (k[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0, n ||
                                E ? (c.beginPath(), c.moveTo(r, q), x = {
                                    x: r,
                                    y: q
    ...
    w.prototype.renderStackedArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                g = [],
                l = 0,
                p, h, k, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) <<
                0,
                ...
                if (0 < g.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof x.y) {
                            p = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit *
                            ...
                            0 <= q.dataPointIndexes[k] && 0 !== x.markerSize && (0 < x.markerSize || 0 < q.markerSize) && (k = q.getMarkerProperties(l, p, h, b), d.push(k), markerColor = A(B), v && d.push({
                                x: p,
                                y: h,
                                ctx: m,
                                type: k.type,
    ...
    w.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null,
                ...
                r = 0.9 * d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(r) << 0,
                ...
                if (0 < g.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        ...
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof w.y) {
                            ...
                            else if (b.lineTo(p, h), v && q.lineTo(p, h), 0 == l % 250) {
                            ...
                            0 <= u.dataPointIndexes[k] && 0 !== w.markerSize && (0 < w.markerSize || 0 < u.markerSize) && (k = u.getMarkerProperties(l, p, h, b), e.push(k), markerColor = A(y), v && e.push({
                                x: p,
                                y: h,
                                ctx: q,
                                type: k.type,
                    ...
                    b.beginPath();
                    b.moveTo(p, h);
                    v && (q.closePath(), q.fill(), q.beginPath(),
                        q.moveTo(p, h))
                }
    ...
    w.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= c)) {
            ...
            b.rect(d.x1, d.y1, d.width, d.height);
            b.clip();
            v && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height),
            ...
            for (var s = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, s), k = 0; k < a.dataSeriesIndexes.length; k++)
                if (n = a.dataSeriesIndexes[k],
                    m = this.data[n], r = m.dataPoints, 1 == r.length && (c = l), 1 > c ? c = 1 : c > l && (c = l), 0 < r.length)
                    for (b.strokeStyle = "#4572A7 ", e = 0; e < r.length; e++)
                        if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
                            ...
                            g = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (r[e].y - a.axisY.conversionParameters.minimum) +
                                0.5 << 0;
                            var q = r[e].z,
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var m = 0, r = 0, e = 0; e < n.length; e++)
                        if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" ===
                            typeof n[e].y) {
                            f = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (f - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            I.drawMarker(q.x, q.y, q.ctx, q.type, q.size, q.color, q.color, q.thickness);
                            b.globalAlpha = 1;
                            Math.sqrt((m - f) * (m - f) + (r - g) * (r - g)) < Math.min(q.size, 5) && n.length > Math.min(this.plotArea.width,
                                this.plotArea.height) || (m = k.dataPointIds[e], this._eventManager.objectMap[m] = {
                                id: m,
                                objectType: "dataPoint",
                                dataSeriesIndex: h,
                                dataPointIndex: e,
                ...
                if (0 < s.length)
                    for (var u = 5 < n && q.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)
                        if (s[e].getTime ? k = s[e].x.getTime() : k = s[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                            ...
                            "candlestick" === q.type ? (b.moveTo(f - w, l), b.lineTo(f - w, Math.min(g, h)), b.stroke(), b.moveTo(f - w, Math.max(g, h)), b.lineTo(f - w, p), b.stroke(),
                                ...
                                w, l), c.lineTo(f - w, p), c.stroke(), c.beginPath(), c.moveTo(f, g), c.lineTo(t, g), c.stroke(), c.beginPath(), c.moveTo(f, h), c.lineTo(x, h), c.stroke()));
                ...
                if (0 < n.length)
                    for (var m = 5 < l && k.bevelEnabled ? !0 : !1, e = 0; e < n.length; e++)
                        if (n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
                            ...
                            d = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (n[e].y[0] - a.axisY.conversionParameters.minimum) +
                                0.5 << 0;
                            ...
                            c = A(s);
                            v &&
                                D(this._eventManager.ghostCtx, r, d, q, f, c, 0, null, !1, !1, !1, !1);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < m.length) {
                    ...
                    b.strokeStyle = "#4572A7 ";
                    for (e = 0; e < m.length; e++)
                        if (m[e].getTime ? l = m[e].x.getTime() : l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) &&
                            ...
                            c = A(c);
                            v && D(this._eventManager.ghostCtx, d, g, f, q, c, 0, null, !1, !1, !1, !1);
                    ...
                    for (var x = !0; n < h.length; n++)
                        if (s = h[n].x.getTime ? h[n].x.getTime() : h[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if (null !== h[n].y && h[n].y.length && "number" === typeof h[n].y[0] && "number" === typeof h[n].y[1]) {
                                ...
                                r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (h[n].y[0] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                q = a.axisY.conversionParameters.reference +
                                    a.axisY.conversionParameters.pixelPerUnit * (h[n].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
        ...
        function b() {
            ...
            if (0 < a.length) {
                ...
                for (var b = 0; b < a.length - 3; b += 3) c.bezierCurveTo(a[b + 1].x, a[b + 1].y, a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y), v && d.bezierCurveTo(a[b + 1].x, a[b + 1].y,
                    a[b + 2].x, a[b + 2].y, a[b + 3].x, a[b + 3].y);
                ...
                if (0 < l.lineThickness) {
                    ...
                    for (b = a.length - 1; 2 < b; b -= 3) c.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x,
                        a[b - 2].y, a[b - 3].x, a[b - 3].y), v && d.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y);
                    c.stroke()
                }
                c.beginPath();
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < p.length) {
                    ...
                    for (c.lineWidth = l.lineThickness; h < p.length; h++)
                        if (k = p[h].x.getTime ? p[h].x.getTime() : p[h].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax))
                            if (null !== p[h].y && p[h].y.length && "number" === typeof p[h].y[0] && "number" === typeof p[h].y[1]) {
                                k = a.axisX.conversionParameters.reference +
                                    a.axisX.conversionParameters.pixelPerUnit * (k - a.axisX.conversionParameters.minimum) + 0.5 << 0;
    ...
    var na = function(a, b, c, d, e, f, g, l) {
        ...
        a.save();
        a.globalAlpha = l;
        "pie" === e ? (a.beginPath(), a.moveTo(b.x, b.y), a.arc(b.x,
            b.y, c, f, g, !1), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(b.x, b.y, c, f, g, !1), a.arc(b.x, b.y, 0.6 * c, g, f, !0), a.closePath(), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
        a.globalAlpha = 1;
        a.restore()
    };
    w.prototype.renderPie = function(a) {
        ...
        function c() {
            if (n && m) {
                ...
                for (var c = 0, d = 0, e = 0, g = 0, b = 0; b < m.length; b++) {
                    ...
                    h.indexLabelLineColor = f.indexLabelLineColor ? f.indexLabelLineColor : n.indexLabelLineColor ? n.indexLabelLineColor : f.color ? f.color : n._colorSet[b % n._colorSet.length];
                    h.indexLabelLineThickness =
                        f.indexLabelLineThickness ? f.indexLabelLineThickness : n.indexLabelLineThickness;
                    ...
                    h.indexLabelFontSize = f.indexLabelFontSize ? f.indexLabelFontSize : n.indexLabelFontSize;
                    ...
                    h.indexLabelTextBlock = new H(k.plotArea.ctx, {
                ...
                f = a = 0;
                l = !1;
                for (b = 0; b < m.length; b++) h = t[(e + b) % m.length], 1 < c && (h.midAngle > Math.PI / 2 - y && h.midAngle < Math.PI / 2 + y) && (a <= c / 2 && !l ? (h.hemisphere = "right", a++) : (h.hemisphere = "left", l = !0));
                l = !1;
                for (b = 0; b < m.length; b++) h = t[(g + b) % m.length], 1 < d && (h.midAngle >
                    3 * Math.PI / 2 - y && h.midAngle < 3 * Math.PI / 2 + y) && (f <= d / 2 && !l ? (h.hemisphere = "left", f++) : (h.hemisphere = "right", l = !0))
            }
        }
        ...
        function d() {
            ...
            if (null !== u && u.frame < u.maxFrames) {
                ...
                for (var a = u.prevMaxAngle + 2 * Math.PI / u.maxFrames, c = 0; c < m.length; c++) {
                    ...
                    f > a && (f = a, h = !0);
                    var l = m[c].color ?
                        m[c].color : n._colorSet[c % n._colorSet.length];
        ...
        function e() {
            ...
            if (null !== u && u.frame < u.maxFrames) {
                ...
                for (a = 0; a < m.length; a++) {
                    ...
                    if (c > b) {
                        var d =
                            0.07 * z * Math.cos(t[a].midAngle),
                            g = 0.07 * z * Math.sin(t[a].midAngle),
                            f = !1;
                        if (m[a].exploded) {
                            if (Math.abs(t[a].center.x - (G.x + d)) > Math.abs(0.5 * d / u.maxFrames) || Math.abs(t[a].center.y - (G.y + g)) > Math.abs(0.5 * g / u.maxFrames)) t[a].center.x += d / u.maxFrames, t[a].center.y += g / u.maxFrames, f = !0
                        } else if (Math.abs(t[a].center.x - G.x) > Math.abs(0.5 * d / u.maxFrames) || Math.abs(t[a].center.y - G.y) > Math.abs(0.5 * g / u.maxFrames)) t[a].center.x -= d / u.maxFrames, t[a].center.y -= g / u.maxFrames, f = !0;
                        f && (d = {}, d.dataSeries = n, d.dataPoint = n.dataPoints[a],
                            d.index = a, k._toolTip.highlightObjects([d]));
                ...
                a.textBaseline = "middle";
                a.lineJoin = "round";
                for (b = b = 0; b < m.length; b++) c = t[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "outside" === n.indexLabelPlacement ? -(c.indexLabelTextBlock.width + r) : -c.indexLabelTextBlock.width /
                    2 : "outside" === n.indexLabelPlacement ? r : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "outside" === c.indexLabelPlacement && (d = c.center.x + z * Math.cos(c.midAngle), g = c.center.y + z * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.beginPath(), a.moveTo(d, g), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x +
                        ("left" === c.hemisphere ? -r : r), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
        ...
        function f(a, b) {
            ...
            return a.indexLabelTextBlock.x +
                a.indexLabelTextBlock.width < b.indexLabelTextBlock.x - r || c > f + r || d > h + r || e < g - r ? !1 : !0
        }
        ...
        function p(a, b) {
            ...
            if (0 <= a && a < m.length) {
                ...
                var h = b,
                    ...
                    n = 0,
                    n = k = k = 0;
                0 > h ? f.indexLabelTextBlock.y - f.indexLabelTextBlock.height / 2 > d && f.indexLabelTextBlock.y - f.indexLabelTextBlock.height /
                    2 + h < d && (h = -(d - (f.indexLabelTextBlock.y - f.indexLabelTextBlock.height / 2 + h))) : f.indexLabelTextBlock.y + f.indexLabelTextBlock.height / 2 < d && f.indexLabelTextBlock.y + f.indexLabelTextBlock.height / 2 + h > e && (h = f.indexLabelTextBlock.y + f.indexLabelTextBlock.height / 2 + h - e);
                ...
                k = Math.sqrt(Math.pow(d - n, 2) + Math.pow(h -
                    k, 2));
                n = Math.acos(z / F);
                ...
                for (e = 1; e < m.length; e++)
                    if (d = (a - e + t.length) % t.length, t[d].hemisphere !== t[a].hemisphere) {
                        d = null;
                        break
                    } else if (t[d].indexLabelText && t[d].hemisphere === t[a].hemisphere && d !== a && (0 > g(t[d], t[a]) || ("right" === t[a].hemisphere ? t[d].indexLabelTextBlock.y <= t[a].indexLabelTextBlock.y : t[d].indexLabelTextBlock.y >= t[a].indexLabelTextBlock.y))) break;
                else d = null;
                n = d;
                k = l(a);
                e = d = 0;
                0 > h ? (e = "right" === f.hemisphere ? n : k, c = h, null !==
                    e && (n = -h, h = f.indexLabelTextBlock.y - f.indexLabelTextBlock.height / 2 - (t[e].indexLabelTextBlock.y + t[e].indexLabelTextBlock.height / 2), h - n < w && (d = -n, s++, e = p(e, d), +e.toFixed(B) > +d.toFixed(B) && (c = h > w ? -(h - w) : -(n - (e - d)))))) : 0 < h && (e = "right" === f.hemisphere ? k : n, c = h, null !== e && (n = h, h = t[e].indexLabelTextBlock.y - t[e].indexLabelTextBlock.height / 2 - (f.indexLabelTextBlock.y + f.indexLabelTextBlock.height / 2), h - n < w && (d = n, s++, e = p(e, d), +e.toFixed(B) < +d.toFixed(B) && (c = h > w ? h - w : n - (d - e)))));
                c && (h = f.indexLabelTextBlock.y + c, d = 0, d =
                    "right" === f.hemisphere ? G.x + Math.sqrt(Math.pow(F, 2) - Math.pow(h - G.y, 2)) : G.x - Math.sqrt(Math.pow(F, 2) - Math.pow(h - G.y, 2)), f.midAngle > Math.PI / 2 - y && f.midAngle < Math.PI / 2 + y ? (e = (a - 1 + t.length) % t.length, e = t[e], n = t[(a + 1 + t.length) % t.length], "left" === f.hemisphere && "right" === e.hemisphere && d > e.indexLabelTextBlock.x ? d = e.indexLabelTextBlock.x - 15 : "right" === f.hemisphere && ("left" === n.hemisphere && d < n.indexLabelTextBlock.x) && (d = n.indexLabelTextBlock.x + 15)) : f.midAngle > 3 * Math.PI / 2 - y && f.midAngle < 3 * Math.PI / 2 + y && (e = (a - 1 + t.length) %
                        t.length, e = t[e], n = t[(a + 1 + t.length) % t.length], "right" === f.hemisphere && "left" === e.hemisphere && d < e.indexLabelTextBlock.x ? d = e.indexLabelTextBlock.x + 15 : "left" === f.hemisphere && ("right" === n.hemisphere && d > n.indexLabelTextBlock.x) && (d = n.indexLabelTextBlock.x - 15)), f.indexLabelTextBlock.y = h, f.indexLabelTextBlock.x = d, f.indexLabelAngle = Math.atan2(f.indexLabelTextBlock.y - G.y, f.indexLabelTextBlock.x - G.x))
            }
            return c
        }
        ...
        function h() {
            ...
            for (var c = 0, e = a = 0, a = 0; 10 > a && (1 > a || 0 < e); a++) {
                ...
                if ("outside" === n.indexLabelPlacement) {
                    ...
                    for (var s, u, c = 0; c < m.length; c++) {
                        ...
                        if (null !== y) {
                            ...
                            var C = 0,
                                C = g(s, u) - w;
                            if (0 > C) {
                                for (var D = u = s = 0; D < m.length; D++) D !== c && t[D].hemisphere === h.hemisphere && (t[D].indexLabelTextBlock.y < h.indexLabelTextBlock.y ?
                                    s++ : u++);
                                D = C / (s + u || 1) * u;
                                s = -1 * (C - D);
                                var H = u = 0;
                    ...
                    for (c = 0; c < m.length; c++) h = t[c], F = "pie" === n.type ? 0.7 * z : 0.8 * z, C = G.x + F * Math.cos(h.midAngle), D = G.y + F * Math.sin(h.midAngle), h.indexLabelTextBlock.x = C, h.indexLabelTextBlock.y = D;
                for (c = 0; c < m.length; c++) h = t[c], C = h.indexLabelTextBlock.measureText(),
                    0 !== C.height && 0 !== C.width && (C = C = 0, "right" === h.hemisphere ? (C = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + r), C *= -1) : C = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - r), 0 < C && (Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - G.y) < z || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - G.y) < z) && (C /= Math.abs(Math.cos(h.indexLabelAngle)), 9 < C && (C *= 0.3), C > e && (e = C)), C = C = 0, 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? (C = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height /
                        2 + 5), C *= -1) : C = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5), 0 < C && Math.abs(h.indexLabelTextBlock.x - G.x) < z && (C /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < C && (C *= 0.3), C > e && (e = C)));
                c = function(a, b, c) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var n = this.data[a.dataSeriesIndexes[0]],
                ...
                z = "inside" === n.indexLabelPlacement ? 0.95 * Math.min(q.width, q.height) / 2 : 0.8 *
                Math.min(q.width, q.height) / 2,
                F = z * A;
    ...
    H.prototype._wrapText = function() {
        ...
        for (this.ctx.font = this._getFontString(); 0 < a.length;) {
            ...
            e =
                Math.max(e, g.width);
            d += g.height;
            a = X(a.slice(g.text.length, a.length));
    ...
    $.prototype.render = function() {
        if (this.text) {
            var a = this.chart.layoutManager.getFreeSpace(),
                ...
                f = 0,
                g, l;
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? (e = a.width - 2 * this.margin, f = 0.5 * a.height -
                2 * this.margin, d = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (e = a.height - 2 * this.margin, f = 0.5 * a.width - 2 * this.margin) : "center" === this.horizontalAlign && (e = a.width - 2 * this.margin, f = 0.5 * a.height - 2 * this.margin));
            var f = new H(this.ctx, {
                ...
                p = f.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (c = this.margin, l = "top") : "bottom" === this.verticalAlign && (c = a.y2 - this.margin - p.height, l = "bottom"), "left" === this.horizontalAlign ? b = a.x1 + this.margin : "center" === this.horizontalAlign ? b = a.x1 + (e / 2 - p.width / 2) + this.margin :
                ...
                2), b = a.x1 + (a.width / 2 - p.width / 2), l = "center", this.width = p.width, this.height = p.height), g = "center");
            f.x = b;
            f.y = c;
            f.angle = d;
            f.horizontalAlign = g;
    ...
    fa.prototype.render = function() {
        ...
        "top" === this.verticalAlign || "bottom" ===
            this.verticalAlign ? (this.orientation = "horizontal", b = this.verticalAlign, e = 0.9 * a.width, f = 0.5 * a.height) : "center" === this.verticalAlign && (this.orientation = "vertical", b = this.horizontalAlign, e = 0.5 * a.width, f = 0.9 * a.height);
        for (var p = 0; p < this.dataSeries.length; p++) {
            var h = this.dataSeries[p],
                k = h.legendMarkerType ? h.legendMarkerType : "line" !== h.type && "stepLine" !== h.type && "spline" !== h.type && "scatter" !== h.type && "bubble" !== h.type || !h.markerType ? O.getDefaultLegendMarker(h.type) : h.markerType,
                n = h.legendText ? h.legendText :
                h.name,
            ...
            if ("pie" !== h.type && "doughnut" !== h.type && "funnel" !== h.type) k = {
                ...
                for (var q = 0; q < h.dataPoints.length; q++) r = h.dataPoints[q], k = r.legendMarkerType ? r.legendMarkerType :
                    h.legendMarkerType ? h.legendMarkerType : O.getDefaultLegendMarker(h.type), n = r.legendText ? r.legendText : h.legendText ? h.legendText : r.name ? r.name : "DataPoint: " + (q + 1), m = r.markerColor ? r.markerColor : h.markerColor ? h.markerColor : r.color ? r.color : h.color ? h.color : h._colorSet[q % h._colorSet.length], r = 0 === r.markerSize || 0 === h.markerSize && !r.markerSize ? 0 : 0.6 * this.lineHeight, k = {
                        markerType: k,
                        markerColor: m,
                        text: n,
                        textBlock: null,
            ...
            for (p = q = 0; p < g.length; p++) {
                ...
                if ("horizontal" === this.orientation) {
                    ...
                    if (!h || h.width + k.textBlock.width + (0 === h.width ? 0 : this.horizontalSpacing) > e) h = {
                        items: [],
                        width: 0
                    }, l.push(h), this.height = l.length * (k.textBlock.height +
                        5);
        ...
        "top" === this.verticalAlign ? (d = "left" === this.horizontalAlign ? a.x1 + 2 : "right" === this.horizontalAlign ? a.x2 - this.width - 2 : a.x1 + a.width / 2 - this.width / 2, c = a.y1) : "center" === this.verticalAlign ? (d = "left" === this.horizontalAlign ? a.x1 + 2 : "right" ===
            this.horizontalAlign ? a.x2 - this.width - 2 : a.x1 + a.width / 2 - this.width / 2, c = a.y1 + a.height / 2 - this.height / 2) : "bottom" === this.verticalAlign && (d = "left" === this.horizontalAlign ? a.x1 + 2 : "right" === this.horizontalAlign ? a.x2 - this.width - 2 : a.x1 + a.width / 2 - this.width / 2, c = a.y2 - this.height - 5);
        this.items = g;
        for (p = 0; p < this.items.length; p++) k = g[p], k.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[k.id] = {
            id: k.id,
        ...
        for (p = 0; p < l.length; p++)
            for (h = l[p], a = 0; a < h.items.length; a++) {
                ...
                if ("line" === k.chartType || "stepLine" === k.chartType || "spline" === k.chartType) this.ctx.strokeStyle = k.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(f - 0.1 * this.lineHeight, g + this.lineHeight / 2), this.ctx.lineTo(f +
                    0.7 * this.lineHeight, g + this.lineHeight / 2), this.ctx.stroke(), e -= 0.1 * this.lineHeight;
                ...
                k.x1 =
                    this.chart._eventManager.objectMap[k.id].x1 = e;
    ...
    O.prototype.getDataPointAtX = function(a, b) {
        ...
        "none" !== this.chart.plotInfo.axisPlacement &&
            (k = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, k = 0 < k ? Math.min(Math.max((this.dataPoints.length - 1) / k * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0);
        for (;;) {
            f = 0 < g ? k + e : k - e;
    ...
    O.prototype.getDataPointAtXY = function(a, b, c) {
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (m) {
                    switch (this.type) {
                        ...
                        case "doughnut":
                            s = m.center;
                            u = "doughnut" === this.type ? 0.6 * m.radius : 0;
                            q = Math.sqrt(Math.pow(s.x - a, 2) + Math.pow(s.y - b, 2));
                            q < m.radius && q > u && (q = Math.atan2(b - s.y, a - s.x), 0 > q && (q += 2 * Math.PI), q = (180 * (q / Math.PI) % 360 + 360) % 360, s = (180 * (m.startAngle / Math.PI) % 360 + 360) % 360, u = (180 * (m.endAngle / Math.PI) % 360 + 360) %
                                360, 0 === u && 1 < m.endAngle && (u = 360), s > u && (u += 360, q < s && (q += 360)), q > s && q < u && (d.push({
                                    dataPoint: r,
                                    dataPointIndex: f,
                                    dataSeries: this,
                                    distance: 0
        ...
        a = null;
        for (b =
            0; b < d.length; b++) a ? d[b].distance <= a.distance && (a = d[b]) : a = d[b];
        return a
    };
    O.prototype.getMarkerProperties = function(a, b, c, d) {
        ...
        return {
            ...
            borderColor: e[a].markerBorderColor ? e[a].markerBorderColor : this.markerBorderColor ?
    ...
    z.prototype.createLabels = function() {
        var a, b = 0,
            ...
            e = 0,
            b = 0;
        if ("bottom" === this._position || "top" === this._position) b = this.lineCoordinates.width / Math.abs(this.maximum - this.minimum) * this.interval, d = this.labelAutoFit ? "undefined" === typeof this._options.labelMaxWidth ? 0.9 * b >> 0 : this.labelMaxWidth : "undefined" === typeof this._options.labelMaxWidth ?
            0.7 * this.chart.width >> 0 : this.labelMaxWidth, e = "undefined" === typeof this._options.labelWrap || this.labelWrap ? 0.5 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
            ...
            typeof this._options.labelWrap || this.labelWrap ? 2 * b >> 0 : 1.5 * this.labelFontSize;
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (c = oa(new Date(this.maximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < c; oa(b, this.interval, this.intervalType)) a = b.getTime(), a = "axisX" === this.type && this.labels[a] ? this.labels[a] : xa(b, this.valueFormatString, this.chart._cultureInfo), a = new H(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: d,
                maxHeight: e,
            ...
            if (this.labels && this.labels.length) {
                ...
                g && (this.interval = a, this.intervalStartPosition =
                    f)
            }
            for (b = this.intervalStartPosition; b <= c; b += this.interval) a = "axisX" === this.type && this.labels[b] ? this.labels[b] : ga(b, this.valueFormatString, this.chart._cultureInfo), a = new H(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: d,
                maxHeight: e,
    ...
    z.prototype.createLabelsAndCalculateWidth = function() {
        ...
        return (this.title ? aa(this.titleFontFamily, this.titleFontSize, this.titleFontWeight) +
    ...
    z.prototype.createLabelsAndCalculateHeight = function() {
        ...
        return (this.title ? aa(this.titleFontFamily,
    ...
    z.setLayoutAndRender = function(a, b, c, d, e) {
        ...
        if ("normal" === d) {
            ...
            b && (f = Math.round(e.x1 + b.margin), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(e.x1 + n + b.margin), l = Math.round(e.y2 - m - a.margin), b.lineCoordinates = {
                x1: g,
                y1: d,
                x2: g,
                y2: l,
            ...
            c && (f = Math.round(a.lineCoordinates.x2), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(f + k + c.margin), l =
            ...
            var m = Math.ceil(b ? b.createLabelsAndCalculateHeight() : 0),
                r = Math.ceil(c ? c.createLabelsAndCalculateHeight() :
                    0);
            ...
            c && (d = Math.round(e.y1 + c.margin), l = e.y1 + c.margin + r, c.lineCoordinates.y1 = l, c.lineCoordinates.y2 = l, c.boundingRect = {
                x1: f,
                y1: d,
                x2: g,
                y2: l,
            ...
            l = Math.round(b ? b.lineCoordinates.y1 :
                e.y2 - k > a.chart.height - 10 ? a.chart.height - 10 : e.y2 - k);
            a.lineCoordinates = {
                x1: g,
                y1: d,
                x2: g,
        ...
        e = a.chart.plotArea;
        h.save();
        h.rect(e.x1, e.y1, Math.abs(e.x2 - e.x1), Math.abs(e.y2 -
            e.y1));
        h.clip();
    ...
    z.prototype.renderLabelsTicksAndTitle =
        function() {
            var a = !1,
                b = 0,
                c = 1,
            ...
            if ("undefined" === typeof this._options.interval) {
                ...
                if ("left" === this._position || "right" === this._position) {
                    for (e = 0; e <
                        this._labels.length; e++) f = this._labels[e], f.position < this.minimum || f.stripLine || (f = f.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), b += f);
            ...
            if ("bottom" === this._position) {
                for (var e = 0, f, e = 0; e < this._labels.length; e++)
                    if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                        ...
                        if (!a || 0 === d++ % 2 || this._labels[e].stripLine) 0 === f.textBlock.angle ? (b.x -= f.textBlock.width / 2, b.y += this.tickLength +
                            f.textBlock.fontSize / 2) : (b.x -= 0 > this.labelAngle ? f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0, b.y += this.tickLength + Math.abs(0 > this.labelAngle ? f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)), f.textBlock.x = b.x, f.textBlock.y = b.y, f.textBlock.render(!0)
                    }
                ...
                for (e = 0; e < this._labels.length; e++)
                    if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                        ...
                        if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType) this._labels[e].stripLine ? (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, this.ctx.beginPath(), this.ctx.moveTo(c,
                            b.y << 0), this.ctx.lineTo(c, b.y - this.tickLength << 0), this.ctx.stroke();
                ...
                for (e = 0; e < this._labels.length; e++)
                    if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                        ...
                        if (this.tickThickness && !this._labels[e].stripLine || this._labels[e].stripLine && "pixel" === this._labels[e].stripLine._thicknessType) this._labels[e].stripLine ? (c = this._labels[e].stripLine, this.ctx.lineWidth = c.thickness, this.ctx.strokeStyle = c.color) : (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor), c = 1 === this.ctx.lineWidth %
                            2 ? (b.y << 0) + 0.5 : b.y << 0, this.ctx.beginPath(), this.ctx.moveTo(b.x << 0, c), this.ctx.lineTo(b.x - this.tickLength << 0, c), this.ctx.stroke();
                        if (!a || 0 === d++ % 2 || this._labels[e].stripLine) f.textBlock.x = b.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5, f.textBlock.y = 0 === this.labelAngle ? b.y - f.textBlock.height / 2 + this.labelFontSize / 2 : b.y - f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), f.textBlock.render(!0)
                    }
                this.title && (this._titleTextBlock = new H(this.ctx, {
    ...
    z.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a)
            for (var b = this.chart.plotArea.ctx, c = 0, c =
                    0; c < this.stripLines.length; c++) {
    ...
    z.prototype.renderGrid = function() {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)
                for (d = 0; d < this._labels.length && !this._labels[d].stripLine; d++) this._labels[d].position <
                    this.minimum || this._labels[d].position > this.maximum || (a.beginPath(), b = this.getPixelCoordinatesOnAxis(this._labels[d].position), b = 1 === a.lineWidth % 2 ? (b.x << 0) + 0.5 : b.x << 0, a.moveTo(b, c.y1 << 0), a.lineTo(b, c.y2 << 0), a.stroke());
            else if ("left" === this._position || "right" === this._position)
                for (var d = 0; d < this._labels.length && !this._labels[d].stripLine; d++) this._labels[d].position < this.minimum || this._labels[d].position > this.maximum || (a.beginPath(), b = this.getPixelCoordinatesOnAxis(this._labels[d].position), b = 1 ===
                    a.lineWidth % 2 ? (b.y << 0) + 0.5 : b.y << 0, a.moveTo(c.x1 << 0, b), a.lineTo(c.x2 << 0, b), a.stroke())
        }
    };
    z.prototype.renderAxisLine = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            ...
            this._position && "right" !== this._position || !this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, b = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 << 0, a.beginPath(), a.moveTo(b, this.lineCoordinates.y1), a.lineTo(b, this.lineCoordinates.y2), a.stroke())
    };
    z.prototype.getPixelCoordinatesOnAxis = function(a) {
        var b = {},
            c = this.lineCoordinates.width,
            d = this.lineCoordinates.height;
        if ("bottom" === this._position || "top" === this._position) c /= Math.abs(this.maximum -
            this.minimum), b.x = this.lineCoordinates.x1 + c * (a - this.minimum), b.y = this.lineCoordinates.y1;
    ...
    z.prototype.getXValueAt = function(a) {
        if (!a) return null;
        var b = null;
        "left" === this._position ? b = (this.chart.axisX.maximum - this.chart.axisX.minimum) / this.chart.axisX.lineCoordinates.height * (this.chart.axisX.lineCoordinates.y2 - a.y) + this.chart.axisX.minimum :
    ...
    z.prototype.calculateValueToPixelconversionParameters = function(a) {
        ...
        if ("bottom" === this._position || "top" === this._position) a.pixelPerUnit = b / Math.abs(this.maximum - this.minimum),
    ...
    z.prototype.calculateAxisParameters = function() {
        ...
        var a = "axisX" === this.type ? 500 > this.maxWidth ? 8 : Math.max(6,
                Math.floor(this.maxWidth / 62)) : Math.floor(this.maxWidth / 40),
            b, c, d, e;
        "axisX" === this.type ? (b = null !== this.sessionVariables.internalMinimum ? this.sessionVariables.internalMinimum : this.dataInfo.viewPortMin, c = null !== this.sessionVariables.internalMaximum ? this.sessionVariables.internalMaximum : this.dataInfo.viewPortMax, 0 === c - b && (c += 0.4, b -= 0.4), d = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < c - b ? 0.5 * Math.abs(c - b) : 1) : "axisY" === this.type && (b = "undefined" === typeof this._options.minimum ? this.dataInfo.viewPortMin :
            this._options.minimum, c = "undefined" === typeof this._options.maximum ? this.dataInfo.viewPortMax : this._options.maximum, 0 === c - b ? (c += 5, b -= 5) : (0 !== c && (c += Math.abs(0.05)), 0 !== b && (b -= Math.abs(0.05))), this.includeZero && "undefined" === typeof this._options.minimum && 0 < b && (b = 0), this.includeZero && "undefined" === typeof this._options.maximum && 0 > c && (c = 0));
        "axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType ? (e = c - b, this.intervalType || (e / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : e / 2 <= a ? (this.interval =
            ...
            (this.minimum = b - d / 2), this.sessionVariables.internalMaximum || (this.maximum = c + d / 2), this.intervalStartPosition = Math.floor((this.minimum + 0.2 * this.interval) / this.interval) * this.interval) : "axisY" === this.type && (this.intervalStartPosition = this.minimum));
        "axisX" === this.type && (this._absoluteMinimum = this._options && "undefined" !== typeof this._options.minimum ? this._options.minimum : this.dataInfo.min - d / 2, this._absoluteMaximum = this._options && "undefined" !== typeof this._options.maximum ? this._options.maximum : this.dataInfo.max +
            d / 2);
    ...
    z.prototype.getLabelStartPoint = function() {
        var a = W(this.interval, this.intervalType),
            ...
            for (var d = 0, c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    var d = this.chart.data[e.dataSeriesIndex],
                        f = e.dataPointIndex;
                    if ("line" === d.type ||
                        "stepLine" === d.type || "spline" === d.type || "scatter" === d.type || "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" === d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type) {
                        ...
                        I.drawMarkers([g]);
                        "undefined" !== typeof e.y2 && (g = d.getMarkerProperties(f, e.x1,
                            e.y2, this.chart.overlaidCanvasCtx), g.size = Math.max(1.5 * g.size << 0, 10), g.borderColor = g.borderColor || "#FFFFFF", g.borderThickness = g.borderThickness || Math.ceil(0.1 * g.size), I.drawMarkers([g]))
                    } else "bubble" === d.type ? (g = d.getMarkerProperties(f, e.x1, e.y1, this.chart.overlaidCanvasCtx), g.size = e.size, g.color = "white", g.borderColor = "white", b.globalAlpha = 0.3, I.drawMarkers([g]), b.globalAlpha = 1) : "column" === d.type || "stackedColumn" === d.type || "stackedColumn100" === d.type || "bar" === d.type || "rangeBar" === d.type || "stackedBar" ===
                        d.type || "stackedBar100" === d.type || "rangeColumn" === d.type ? D(b, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === d.type || "doughnut" === d.type ? na(b, e.center, e.radius, "white", d.type, e.startAngle, e.endAngle, 0.3) : "candlestick" === d.type ? (b.globalAlpha = 1, b.strokeStyle = e.color, b.lineWidth = 2 * e.borderThickness, d = 0 === b.lineWidth % 2 ? 0 : 0.5, b.beginPath(), b.moveTo(e.x3 - d, e.y2), b.lineTo(e.x3 - d, Math.min(e.y1, e.y4)), b.stroke(), b.beginPath(), b.moveTo(e.x3 - d, Math.max(e.y1, e.y4)), b.lineTo(e.x3 - d, e.y3), b.stroke(),
                            D(b, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), b.globalAlpha = 1) : "ohlc" === d.type && (b.globalAlpha = 1, b.strokeStyle = e.color, b.lineWidth = 2 * e.borderThickness, d = 0 === b.lineWidth % 2 ? 0 : 0.5, b.beginPath(), b.moveTo(e.x3 - d, e.y2), b.lineTo(e.x3 - d, e.y3), b.stroke(), b.beginPath(), b.moveTo(e.x3, e.y1), b.lineTo(e.x1, e.y1), b.stroke(), b.beginPath(), b.moveTo(e.x3, e.y4), b.lineTo(e.x2, e.y4), b.stroke(), b.globalAlpha = 1)
                }
            }
            b.globalAlpha = 1;
            b.restore()
    ...
    M.prototype.getToolTipInnerHTML =
        function(a) {
            a = a.entries;
            ...
            if (g && this.content && "function" === typeof this.content) b = this.content({
                ...
                for (var p = "", l = 0; l < a.length; l++)
                    if (c = a[l].dataSeries, d = a[l].dataPoint, e = a[l].index, f = "", 0 === l && (g && !this.content) && (p += "undefined" !== typeof this.chart.axisX.labels[d.x] ? this.chart.axisX.labels[d.x] : "{x}", p += "</br>", p = this.chart.replaceKeywordsWithValue(p,
                            d, c, e)), null !== d.toolTipContent && ("undefined" !== typeof d.toolTipContent || null !== c._options.toolTipContent)) {
                        if ("line" === c.type || "stepLine" === c.type || "spline" === c.type || "area" === c.type || "stepArea" === c.type || "splineArea" === c.type || "column" === c.type || "bar" === c.type || "scatter" === c.type || "stackedColumn" === c.type || "stackedColumn100" === c.type || "stackedBar" === c.type || "stackedBar100" === c.type || "stackedArea" === c.type || "stackedArea100" === c.type) f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent :
                            this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>{name}:</span>&nbsp;&nbsp;{y}";
                        ...
                        else if ("pie" === c.type || "doughnut" === c.type || "funnel" === c.type) f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent :
                            this.content && "function" !== typeof this.content ? this.content : "&nbsp;&nbsp;{y}";
                        ...
                        else if ("candlestick" === c.type || "ohlc" === c.type) f += d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent :
                ...
                else if ("pie" === c.type || "doughnut" === c.type || "funnel" === c.type) f = d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : (d.name ?
                    "{name}:&nbsp;&nbsp;" : d.label ? "{label}:&nbsp;&nbsp;" : "") + "{y}";
                else if ("rangeColumn" === c.type || "rangeBar" === c.type || "rangeArea" === c.type || "rangeSplineArea" === c.type) f = d.toolTipContent ? d.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>" + (d.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
                else if ("candlestick" === c.type || "ohlc" === c.type) f = d.toolTipContent ? d.toolTipContent : c.toolTipContent ?
                    c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"'color:{color};'\"'>" + (d.label ? "{label}" : "{x}") + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
                null === b && (b = "");
                b += this.chart.replaceKeywordsWithValue(f, d, c, e)
            }
            return b
    ...
    w.prototype.replaceKeywordsWithValue = function(a, b, c, d, e) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            a = X(a.slice(1, a.length - 1));
            a = a.replace("#index", e);
            var l = null;
            try {
                var p = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                p && 0 < p.length && (l = X(p[2]), a = X(p[1]))
            } catch (h) {}
            p = null;
            if ("color" === a) return b.color ? b.color : c.color ? c.color : c._colorSet[d % c._colorSet.length];
            if (b.hasOwnProperty(a)) p = b;
            else if (c.hasOwnProperty(a)) p = c;
            else return "";
            p = p[a];
            null !== l && (p = p[l]);
            return "x" === a ? f.axisX && "dateTime" === f.plotInfo.axisXValueType ? xa(p, b.xValueFormatString ? b.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : f.axisX && f.axisX.valueFormatString ? f.axisX.valueFormatString : "DD MMM YY", f._cultureInfo) : ga(p, b.xValueFormatString ?
                b.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : "#,##0.########", f._cultureInfo) : "y" === a ? ga(p, b.yValueFormatString ? b.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : "#,##0.########", f._cultureInfo) : "z" === a ? ga(p, b.zValueFormatString ? b.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : "#,##0.########", f._cultureInfo) : p
        })
    };
    ...
    Y.prototype.getNewObjectTrackingId = function() {
        return ++this.lastObjectId
    };
    Y.prototype.mouseEventHandler = function(a) {
    ...
    Y.prototype.fireEvent = function(a, b, c) {
        if (a && b) {
    ...
    var I = {
            drawMarker: function(a, b, c, d, e, f, g, l) {
                if (c) {
                    ...
                    c.lineWidth = l ? l : 0;
                    "circle" === d ? (c.moveTo(a, b), c.beginPath(), c.arc(a, b, e / 2, 0, 2 * Math.PI, !1), f && c.fill(), l && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p))) : "square" === d ? (c.beginPath(),
                        c.rect(a - e / 2, b - e / 2, e, e), f && c.fill(), l && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p))) : "triangle" === d ? (c.beginPath(), c.moveTo(a - e / 2, b + e / 2), c.lineTo(a + e / 2, b + e / 2), c.lineTo(a, b - e / 2), c.closePath(), f && c.fill(), l && (g ? c.stroke() : (p = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = p)), c.beginPath()) : "cross" === d && (c.strokeStyle = f, c.lineWidth = e / 4, c.beginPath(), c.moveTo(a - e / 2, b - e / 2), c.lineTo(a + e / 2, b + e / 2), c.stroke(), c.moveTo(a +
                        e / 2, b - e / 2), c.lineTo(a - e / 2, b + e / 2), c.stroke())
                }
            },
    ...
    ya.Chart.version = "v1.5.0 Beta 3";
    window.CanvasJS = ya
})();
/*
