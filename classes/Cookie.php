...
class CookieCore
{
    ...
    public function mylogout()
    {
        ...
        unset($this->_content['role']);
        unset($this->_content['id_state_vat']);
        unset($this->_content['name_state_vat']);
        unset($this->_content['budget_configured']);
        unset($this->_content['id_address_budget']);
        unset($this->_content['elite']);
        unset($this->_content['is_perks']);
        unset($this->_content['budget_option']);
        unset($this->_content['delivery_region']);
        unset($this->_content['delivery_region_name']);
        unset($this->_content['id_state']);
        unset($this->_content['id_employee']);
        unset($this->_content['id_purchase_order']);
        unset($this->_content['po_number']);
        unset($this->_content['search_zone']);
        $this->_modified = true;
    }
