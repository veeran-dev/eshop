    ...
    public function checkValidity(Context $context, $alreadyInCart = false, $display_error = true, $check_carrier = true)
    {
        ...
        if ($this->minimum_amount && $check_carrier) {
            ...
            if ($cartTotal < $minimum_amount) {
                return (!$display_error) ? false : Tools::displayError('Unable to apply voucher. This may be due to empty cart or your shopping value is less than the voucher value. Please check and try again.');
            }
        }
