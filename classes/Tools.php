...
class ToolsCore
{
    ...
    */
    ...
    public static function getAdminTokenLiteCustom($tab, $id)
    {
        return Tools::getAdminToken($tab.(int)Tab::getIdFromClassName($tab).(int)$id);
    }
...
';
    ...
    * @return Split array
    */
    public static function group_by($array, $key, $filter = null) {
        $return = array();
