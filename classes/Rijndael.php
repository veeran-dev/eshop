...
class RijndaelCore
{
    ...
    public function encrypt($plaintext)
    {
        ...
        $encrypt_txt = openssl_encrypt($plaintext, 'AES-128-ECB', $this->_key, OPENSSL_CIPHER_AES_128_CBC, $this->_iv);
        
        return base64_encode($encrypt_txt).sprintf('%06d', $length);
    }
    ...
    public function decrypt($ciphertext)
    {
        if (ini_get('mbstring.func_overload') & 2) {
            ...
            return mb_substr(
                openssl_decrypt(base64_decode($ciphertext), 'AES-128-ECB', $this->_key, OPENSSL_CIPHER_AES_128_CBC, $this->_iv),
                0,
                $length,
            ...
            return substr(openssl_decrypt(base64_decode($ciphertext), 'AES-128-ECB', $this->_key, OPENSSL_CIPHER_AES_128_CBC, $this->_iv), 0, $length);
        }
    }
}
