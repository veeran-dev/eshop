...
class ProductCore extends ObjectModel
{
    ...
    /** branded products mrp (only affects in SCN portal) **/
    public $mrp = 0;
	...
	/******************************Created By Sreeni Creted the customize variables for 1.6.1.3*********************/

	  /*@Var Int Discontinued represent whether product is discontinued or available*/
	 public $discontinued;//use to identify the fulfillment center

    /** @var int employee ID created by Elumalai*/
    public $id_employee;

    /** @var int vendor ID  created by Elumalai*/
    public $id_vendor;

    /** @var string HSN code for GST created by Elumalai */
    public $hsn_code;
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'hsn_code' =>                   array('type' => self::TYPE_STRING, 'size' => 8, 'required' => true),
            ...
            'mrp' =>                        array('type' => self::TYPE_FLOAT, 'shop' => true, 'validate' => 'isPrice'),
            ...
            'discontinued' =>            array('type' => self::TYPE_BOOL, 'validate' => 'isBool'),
    ...
    */
    ...
    public function addToCategories($categories = array())
    {
        ...
        $logger->logError('addToCategories');
        $logger->logError($categories);
        if (empty($categories)) {
        ...
        if (!count($categories)) {
            $logger->logError('addToCategories 1038');
            return false;
        }
        ...
        $logger->logError($res_categ_new_pos);
