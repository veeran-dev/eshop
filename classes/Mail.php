...
class MailCore extends ObjectModel
{
    ...
    public static function Send($id_lang, $template, $subject, $template_vars, $to,
        ...
        $template_path = _PS_MAIL_DIR_, $die = false, $id_shop = null, $bcc = null, $reply_to = null, $cc = null)
    {
        if (!$id_shop) {
        ...
        try {
            ...
            //$subject = '['.Configuration::get('PS_SHOP_NAME', null, null, $id_shop).'] '.$subject; // adds [kobster.com]
            ...
            if ($send && Configuration::get('PS_LOG_EMAILS')) {
                ...
                foreach (array_merge($to_list->getTo(), $to_list->getCc(), $to_list->getBcc()) as $recipient) {
                   ...
                   if(substr($recipient->getAddress(), 0, 126) != ""){
                        $mail->id = null;
