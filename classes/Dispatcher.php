...
class DispatcherCore
{
    ...
    protected function __construct()
    {
        ...
        else if(defined('_PS_CORTEX_ADMIN_DIR_')) {
            $this->front_controller = self::FC_CORTEX_ADMIN;
            $this->controller_not_found = 'cortexadminnotfound';
    ...
    public function useDefaultController()
    {
        ...
        if ($this->default_controller === null) {
            if (defined('_PS_ADMIN_DIR_')) {
                ...
                if (empty($this->default_controller)) {
                    $this->default_controller = 'CortexDashboard';
                }
            } elseif (Tools::getValue('fc') == 'module') {
    ...
    public function getController($id_shop = null)
    {
        ...
        if ($this->use_routes && !$controller && !defined('_PS_CORTEX_ADMIN_DIR_') && !defined('_PS_ADMIN_DIR_')) {
            if (!$this->request_uri) {
