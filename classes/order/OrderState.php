...
class OrderStateCore extends ObjectModel
{
    ...
    const FLAG_DELIVERY        = 5;  /* 00100 */
    const FLAG_SHIPPED        = 4;  /* 01000 */
    const FLAG_PAID        = 16; /* 10000 */   
    const FLAG_READY_TO_SHIP = 20;
    const FLAG_PAR_DELIVERY = 21; /* 100 */
    const FLAG_APPROVED     = 29;
    const FLAG_REJECTED     = 30;
    const FLAG_ORDER_PLACED = 22;
    const FLAG_CANCELED = 6;
    const FLAG_BEING_PROCESSED = 19;

    const FLAG_PENDING_INVOICE = 37;
    const FLAG_PENDING_PAYMENT = 35;
    const FLAG_PAYMENT_RECIEVED = 36;
    const FLAG_ORDER_COMPLETED = 38;
    const FLAG_OFFLINE_INVOICE_GENERATED = 34;
    const GENERATE_INVOICE = 25;
    const FLAG_ORDER_REVISED = 31;
    
    const FLAG_INVOICE_SUBMISSION_PENDING = 39;
    const FLAG_INVOICE_SUBMITTED = 40;
    const FLAG_CUSTOMER_VERIFICATION_PENDING = 41;
    const FLAG_CUSTOMER_VERIFIED = 42;
    
    const FLAG_LEVEL2_APPROVED = 43;
	
    const FLAG_WELCOME_CALL_PENDING = 47;
    const FLAG_REVERSE_PICKUP_REQUESTED = 48;
    const FLAG_REVERSE_PICKUP_COMPLETED = 49;
    /**
