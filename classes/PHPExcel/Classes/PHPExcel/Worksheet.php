...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    */
    ...
    public function setSelectedCells($pCoordinate = 'A1')
    {
        ...
        // Convert 'A' to 'A:A'
        $pCoordinate = preg_replace_callback('/^([A-Z]+)$/', '${1}:${1}', $pCoordinate);

        // Convert '1' to '1:1'
        $pCoordinate = preg_replace_callback('/^([0-9]+)$/', '${1}:${1}', $pCoordinate);

        // Convert 'A:C' to 'A1:C1048576'
        $pCoordinate = preg_replace_callback('/^([A-Z]+):([A-Z]+)$/', '${1}1:${2}1048576', $pCoordinate);

        // Convert '1:3' to 'A1:XFD3'
        $pCoordinate = preg_replace_callback('/^([0-9]+):([0-9]+)$/', 'A${1}:XFD${2}', $pCoordinate);
