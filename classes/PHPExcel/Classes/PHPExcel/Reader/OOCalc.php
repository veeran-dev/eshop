...
//									echo 'Formula: ', $cellDataFormula, PHP_EOL;
									...
									foreach($temp as &$value) {
										...
										if ($tKey = !$tKey) {
											$value = preg_replace_callback('/\[([^\.]+)\.([^\.]+):\.([^\.]+)\]/Ui','$1!$2:$3',$value);    //  Cell range reference in another sheet
											$value = preg_replace_callback('/\[([^\.]+)\.([^\.]+)\]/Ui','$1!$2',$value);       //  Cell reference in another sheet
											$value = preg_replace_callback('/\[\.([^\.]+):\.([^\.]+)\]/Ui','$1:$2',$value);    //  Cell range reference
											$value = preg_replace_callback('/\[\.([^\.]+)\]/Ui','$1',$value);                  //  Simple cell reference
