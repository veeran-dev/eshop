...
class HTMLTemplateDeliverySlipCore extends HTMLTemplate
{
    ...
    public function __construct(OrderInvoice $order_invoice, $smarty, $bulk_mode = false)
    {
        ...
        $prefix = $this->order->getDeliveryPrefix();
    ...
    public function getHeader()
    {
        ...
        $this->smarty->assign(array('header' => HTMLTemplateDeliverySlip::l('DELIVERY SLIP'), 'delivery_slip' => true));
    ...
    {
        $prefix = $this->order->getDeliveryPrefix();
        return $prefix.sprintf('%06d', $this->order->delivery_number).'.pdf';
    }
}
