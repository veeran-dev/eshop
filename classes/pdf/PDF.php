...
class PDFCore
{
    ...
    const TEMPLATE_CONSOLIDATED_INVOICE = 'ConsolidatedInvoice';
    const TEMPLATE_ORDER_RETURN = 'OrderReturn';
    const TEMPLATE_ORDER_SLIP = 'OrderSlip';
    const TEMPLATE_DELIVERY_SLIP = 'DeliverySlip';
    const TEMPLATE_PARTIAL_DELIVERY_SLIP = 'PartialDeliverySlip';
    ...
    public function renderPdf($display = true)
    {
        $renderPdf = false;
        $this->pdf_renderer->setFontForLang(Context::getContext()->language->iso_code);
        ...
        $template->assignHookData($objects);
