...
$(document).ready(function(){
	...
	if(file_name != '')
	{
		$('#newImportMatchs').val(file_name);
		$('#newImportMatchs').prop('disabled', true);
	}
	if(pin)
	{
		$("#valueImportMatchs option:contains(" + file_name + ")").attr('selected', 'selected');
		$('#loadImportMatchs').click();
	}

	$('#validateImportFileBtn').click(function(event){
		event.preventDefault();
		$('#saveImportMatchs').click();
		$('#validateImportFile').click();
	});
