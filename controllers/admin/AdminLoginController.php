...
class AdminLoginControllerCore extends AdminController
{
    ...
    public function processLogin()
    {
        ...
        if (!count($this->errors)) {
            ...
            else if($cookie->logged_as == 'rm' || $cookie->logged_as == 'finance' || $cookie->logged_as == 'scn') {
                $this->errors[] = Tools::displayError('Please logout from portal that you have already logged in and then try again.');
