...
class CartControllerCore extends FrontController
{
    ...
    public function init()
    {
        ...
        if (strpos(Tools::getValue('id_product'), '_') !== false) {
            $ids = explode("_", Tools::getValue('id_product'));
            $this->id_product = (int)$ids[1];
            $this->id_supplier = (int)$ids[0];
        }
        else{
    ...
    protected function processDeleteProductInCart()
    {
        ...
        if ($this->context->cart->deleteProduct($this->id_supplier,$this->id_product, $this->id_product_attribute, $this->customization_id, $this->id_address_delivery)) {
