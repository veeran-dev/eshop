...
class SearchControllerCore extends FrontController
{
    ...
    public function init()
    {
        ...
        $this->ajax_search_1 = Tools::getValue('ajaxSearch1');
        $this->internal_search = Tools::getValue('internalSearch');
        $this->scn_internal_search = Tools::getValue('scnInternalSearch');
    ...
    public function initContent()
    {
        ...
        if($this->ajax_search_1) {
            $searchResults = Search::find((int)(Tools::getValue('id_lang')), $query, 0, 10, 'position', 'desc', true);
        ...
        {
            $searchResults = Search::find((int)(Tools::getValue('id_lang')), $query, 0, 20, 'position', 'desc', true, false, null, null, null, true);
