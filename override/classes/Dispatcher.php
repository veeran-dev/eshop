...
class Dispatcher extends DispatcherCore {
    ...
    public function dispatch() {
        ...
        switch ($this->front_controller) {
            ...
            case self::FC_FRONT :
                $controllers = Dispatcher::getControllers(array(_PS_FRONT_CONTROLLER_DIR_, _PS_OVERRIDE_DIR_ . 'controllers/front/', _PS_OVERRIDE_DIR_ . 'controllers/supplier/', _PS_OVERRIDE_DIR_ . 'controllers/internal/'));
            ...
            case self::FC_ADMIN :
                ...
                if ($tab->module) {
                    ...
                    $controllers = Dispatcher::getControllers(array(_PS_ADMIN_DIR_ . '/tabs/', _PS_ADMIN_CONTROLLER_DIR_, _PS_OVERRIDE_DIR_ . 'controllers/admin/', _PS_OVERRIDE_DIR_ . 'controllers/cortex/'));
                    if (!isset($controllers[strtolower($this->controller)])) {
                ...
                case self::FC_CORTEX_ADMIN :
                        if ($this->use_default_controller && !Tools::getValue('token') && Validate::isLoadedObject(Context::getContext()->employee) && Context::getContext()->employee->isLoggedBack()) {
                        Tools::redirectAdmin('index.php?controller=' . $this->controller . '&token=' . Tools::getAdminTokenLite($this->controller));
                    }

                    $controllers = Dispatcher::getControllers(array(_PS_OVERRIDE_DIR_ . 'controllers/cortex/'));
