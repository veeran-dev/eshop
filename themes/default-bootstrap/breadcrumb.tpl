...
<div class="breadcrumb clearfix">
	<a class="home" href="{$content_dir}perksDeals">Perks</a>
	<span class="navigation-pipe">/</span>
	{if $product->name}
		<span class="navigation-page">{$product->name}</span>
	{elseif $path}
...
{else if $page_name }
{if $page_name !='search' && $page_name !='shop'}
<div class="breadcrumb clearfix">
	<a class="home" href="{$link->getPageLink('shop', true)|escape:'html':'UTF-8'}" title="{l s='Return to Home'}">Home</a>
...
{if isset($smarty.get.search_query) && isset($smarty.get.results) && $smarty.get.results > 1 && isset($smarty.server.HTTP_REFERER) && $page_name!='product'}
