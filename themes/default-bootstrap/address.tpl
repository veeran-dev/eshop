...
<div class="">
	...
	<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std" id="add_address">
		...
		{foreach from=$ordered_adr_fields item=field_name}
			{if $field_name eq 'company'}
				<div class="form-group padding-bottom">
					...
					<input placeholder="Company" class="form-control validate" data-validate="{$address_validation.$field_name.validate}" type="text" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{else}{if isset($address->company)}{$address->company|escape:'html':'UTF-8'}{/if}{/if}" />
				</div>
			{/if}
				...
				<div id="vat_area">
					<div id="vat_number">
						<div class="form-group">
							<label for="vat-number">{l s='GST number'}{if isset($required_fields) && in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
			...
			{if $field_name eq 'firstname'}
				<div class="required form-group padding-bottom">
					...
					<input placeholder="Your Name" class="is_required validate form-control" data-validate="{$address_validation.$field_name.validate}" type="text" name="firstname" id="firstname" value="{if isset($smarty.post.firstname)}{$smarty.post.firstname}{else}{if isset($address->firstname)}{$address->firstname|escape:'html':'UTF-8'}{/if}{/if}" />
				</div>
			{/if}
			...
			{if $field_name eq 'address1'}
				<div class="required form-group padding-bottom">
					...
					<input placeholder="Address Line 1" class="is_required validate form-control" data-validate="{$address_validation.$field_name.validate}" type="text" id="address1" name="address1" value="{if isset($smarty.post.address1)}{$smarty.post.address1}{else}{if isset($address->address1)}{$address->address1|escape:'html':'UTF-8'}{/if}{/if}" />
				</div>
			{/if}
			{if $field_name eq 'address2'}
				<div class="required form-group padding-bottom">
					<!--<label for="address2">{l s='Address (Line 2)'}{if isset($required_fields) && in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>-->
					<input  placeholder="Address Line 2" class="validate form-control" data-validate="{$address_validation.$field_name.validate}" type="text" id="address2" name="address2" value="{if isset($smarty.post.address2)}{$smarty.post.address2}{else}{if isset($address->address2)}{$address->address2|escape:'html':'UTF-8'}{/if}{/if}" />
				</div>
			{/if}
			{if $field_name eq 'postcode'}
				...
				<div class="required form-group padding-bottom ">
					...
					<input placeholder="Pincode" class="is_required validate noUniform form-control" data-validate="{$address_validation.$field_name.validate}" type="text" id="postcode" name="postcode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{else}{if isset($address->postcode)}{$address->postcode|escape:'html':'UTF-8'}{/if}{/if}" />
				</div>
			{/if}
			{if $field_name eq 'city'}
				<div class="required form-group padding-bottom">
					...
					{if isset($cities)}
						...
						{foreach $cities as $city}
							<option value="{$city.city_name}" 
										{if $smarty.post.city == $city.city_name}
											selected="selected" 
										{else if $address->city == $city.city_name}
											selected="selected" 
										{/if}>
								{$city.city_name}
							</option>
					...
					{else}
					<input placeholder="City" class="form-control" data-validate="{$address_validation.$field_name.validate}" type="text" name="city" id="city" value="{if isset($smarty.post.city)}{$smarty.post.city}{else}{if isset($address->city)}{$address->city|escape:'html':'UTF-8'}{/if}{/if}" maxlength="64" />
					{/if}
				</div>
			...
			{if $field_name eq 'Country:name' || $field_name eq 'country' || $field_name eq 'Country:iso_code'}
				<div class="required form-group padding-bottom">
					...
					<select id="id_country" class="noUniform form-control" name="id_country">{$countries_list}</select>
				</div>
			{/if}
			...
			{*{if $field_name eq 'phone'}
				...
				<div class="form-group required padding-bottom">
					<!--<label for="phone">{l s='Home phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>-->
					<input placeholder="Mobile" class="{if isset($one_phone_at_least) && $one_phone_at_least}is_required{/if} form-control" type="tel" id="phone" name="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{else}{if isset($address->phone)}{$address->phone|escape:'html':'UTF-8'}{/if}{/if}" onchange="mobile_number();" />
				</div>
			...
			{if $field_name eq 'phone_mobile'}
				...
				<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
					...
					<input placeholder="Mobile" class="validate form-control" data-validate="{$address_validation.phone_mobile.validate}" type="tel" id="phone_mobile" name="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{else}{if isset($address->phone_mobile)}{$address->phone_mobile|escape:'html':'UTF-8'}{/if}{/if}" />
				</div>
			{/if}
		...
		<p class="submit2">
			...
			<a class="button-outline" href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}">
...
<ul class="footer_links clearfix">
	<li>
		{if $isPerks != 1}
		{if ($back == "order.php?step=1" || $back == "order.php?step=3")}
			<a class="button-black" href="{$link->getPageLink($back, true)|escape:'html':'UTF-8'}">
				<span>{l s='Cancel'}</span>
			</a>
		{else}
			<a class="button-black" href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}">
