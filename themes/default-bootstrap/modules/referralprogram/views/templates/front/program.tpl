...
<ul class="footer_links clearfix">
	...
	<li><a class="btn btn-default button button-small" href="{$link->getPageLink('shop', true)|escape:'html':'UTF-8'}" title="{l s='Home' mod='referralprogram'}"><span><i class="icon-chevron-left"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
