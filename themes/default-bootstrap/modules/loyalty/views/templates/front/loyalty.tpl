...
<ul class="footer_links clearfix">
	<li>
		{*<a href="{$link->getPageLink('my-account.php', true)}"><img src="{$img_dir}icon/my-account.gif" alt=""/></a>*}
		<a class="btn btn-default button button-small" href="{$link->getPageLink('my-account.php', true)}">{l s='Back to Your Account' mod='loyalty'}</a>
	</li>
	<li>
		{*<a href="{$base_dir}"><img src="{$img_dir}icon/home.gif" alt="" class="icon" /></a>*}
		<a class="btn btn-default button button-small" {if $isPerks == 1} href="{$base_dir}perksDeals" {else} href="{$base_dir}" {/if}>{l s='Home' mod='loyalty'}</a>
	</li>
</ul>
