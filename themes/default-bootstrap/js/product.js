...
{
	/*** BULK ENQUIRY STARTS ***/
	$('#open-blk-enquiry-form').fancybox({
				'transitionIn': 'fade',
				'transitionOut': 'fade',
				'padding': 30,
				'width':500,
	...
	$(document).on("blur", "#bq_quantity", function(e) {
	    bqHideHint(1);
	});
	$(document).on("blur", "#bq_target_price", function(e) {
	    bqHideHint(2);
	});
	$(document).on("blur", "#bq_pincode", function(e) {
	    bqHideHint(3);
	});
	$(document).on("blur", "#bq_credit", function(e) {
	    bqHideHint(4);
	});
	$(document).on("blur", "#bq_email", function(e) {
	    bqHideHint(6);
	});
	$(document).on("blur", "#bq_password", function(e) {
	    bqHideHint(7);
	});
	$(document).on("blur", "#bq_name", function(e) {
	    bqHideHint(8);
	});
	$(document).on("blur", "#bq_phone", function(e) {
	    bqHideHint(9);
	});

	$(document).on("focus", "#bq_quantity", function(e) {
	    bqShowHint(1);
	});
	$(document).on("focus", "#bq_target_price", function(e) {
	    bqShowHint(2);
	});
	$(document).on("focus", "#bq_pincode", function(e) {
	    bqShowHint(3);
	});
	$(document).on("focus", "#bq_credit", function(e) {
	    bqShowHint(4);
	});
	$(document).on("focus", "#bq_email", function(e) {
	    bqShowHint(6);
	});
	$(document).on("focus", "#bq_password", function(e) {
	    bqShowHint(7);
	});
	$(document).on("focus", "#bq_name", function(e) {
	    bqShowHint(8);
	});
	$(document).on("focus", "#bq_phone", function(e) {
	    bqShowHint(9);
	});

	$(document).on("click", "#bq_get_quote", function(e) {
 	    if(logged)
	    	bqGetQuote(true);
	    else
	    	bqGetQuote(false);
	});
	$(document).on("click", "#bq_sign_in", function(e) {
	    bqSignIn();
	});
	$(document).on("click", "#bq_create_acc", function(e) {
	    createNewAccount();
	});
	$(document).on("click", "#bq_complete_close", function(e) {
	    bqComplete();
	});
	$(document).on("change", "#bq-kob-account", function(e) {
	    bqAccCheck();
	});
...
$(document).on('click', '.product_qty_up', function(e){
	e.preventDefault();
...
$(document).on('click', '.product_qty_down', function(e){
	e.preventDefault();
	fieldName = $(this).data('field-qty');
	var currentVal = parseInt($('input[name='+fieldName+']').val());
...
function colorPickerClick(elt)
{
	...
	var ipa =$('#hidden_ipa_'+id_attribute).val();
	$('#buy_now').attr('data-id-product-attribute',ipa);
	$('#add_to_cart').attr('data-id-product-attribute',ipa);
