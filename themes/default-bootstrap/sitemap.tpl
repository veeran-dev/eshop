    ...
    <div class="col-xs-12 col-sm-6">
		<div class="sitemap_block box">
            ...
            <ul>
                ...
                {/foreach}
                <li>
                    <a href="{$base_dir}about.php" title="{l s='About'}">
                        {l s='About'}
                    </a>
                </li>
                <li>
                    <a href="{$base_dir}sell-with-us.php" title="{l s='Sell With Us'}">
                        {l s='Sell With Us'}
                    </a>
                </li>
                <li>
                    <a href="{$base_dir}contact.php" title="{l s='Contact'}">
                        {l s='Contact'}
                    </a>
                </li>
                <li>
                    <a href="{$base_dir}careers.php" title="{l s='Careers'}">
                        {l s='Careers'}
                    </a>   
                </li>
                {* testing *}
