...
<div class="pagenotfound">
	...
	<p>
		{l s='We\'re sorry, but the Page you\'re looking for is no longer available.'}
	</p>
	...
	<div class="buttons"><a class="btn btn-default button button-medium" href="{$link->getPageLink('shop', true)|escape:'html':'UTF-8'}" title="{l s='Home'}"><span>{l s='Home page'}</span></a></div>
</div>
