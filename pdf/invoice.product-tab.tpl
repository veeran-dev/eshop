...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
	...
	<thead>
	<tr>
		<th class="product header small" width="{$layout.sno.width}%">{l s='S.No' pdf='true'}</th>
		<th class="product header small" width="{$layout.reference.width}%">{l s='HSN' pdf='true'}</th>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
			...
			<td class="product left">
				...
				{else}
					{$order_detail.product_name} <b>({$order_detail.product_reference})</b>
				{/if}

			</td>
			<td class="product center">
				{if isset($order_detail.order_detail_tax_label)}
