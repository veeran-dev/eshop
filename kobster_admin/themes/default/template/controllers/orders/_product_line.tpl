...
<tr class="product-line-row">
	...
	<td>
		<span class="product_price_show">{displayPrice price=$product['unit_price_tax_incl'] currency=$currency->id }</span>
		{if $can_edit}
	...
	<td class="productQuantity text-center">
		<span id="updateQuantity_{$product['id_order_detail']}" class="product_quantity_show{if (int)$product['product_quantity'] - (int)$product['customized_product_quantity'] > 1} badge{/if}">{(int)$product['product_quantity'] - (int)$product['customized_product_quantity']}</span>
		{if $can_edit}
	...
	{/if}
	<td class="productQuantity product_stock text-center">{$product['product_quantity_delivered']}</td>
	...
	<td>
		<input id="dr_id_order_detail[{$product['id_order_detail']}]" class='quantity-checkbox' type="checkbox" data-id="{$product['id_order_detail']}" name="dr_id_order_detail[{$product['id_order_detail']}]" onchange="setCancelQuantity(this,{$product['id_order_detail']})">
		<input id="drQuantity_{$product['id_order_detail']}"  type="number" name="drQuantity[{$product['id_order_detail']}]">
	</td>
	{/if}
