...
<html class="no-js" lang="">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 foot-note">
                    <p class="center-text">In the mean time, you can read our blogs at <a href="http://www.kobster.com/blogs" target="_blank" style="color: #f1f122">www.kobster.com/blogs</a> or check us out on social media with the links below.</p>
        ...
        $(document).ready(function() {
            ...
            var baseUrl = 'http://localhost/kobstereshop/';
