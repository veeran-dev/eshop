        ...
        <div className="list-wrapper">
          ...
          <table>
            ...
            <InfiniteScroll
              ...
              className="qr_container_desktop"
              initialLoad={false} 
              hasMore={this.state.hasMoreItems}>
                {this.state.requests && this.state.requests.length > 0 ? this.state.requests.map((request, i) => {
                  return (
                        <tr key={request.id_quote_request+"_id"} id={request.id_quote_request+"_id"} className={request.id_quote_request+"_class qr_wrapper"}>
                          <td>
                          ...
                          <td>
                            <div className="qr_product_details">
                                <h3>Quotation #{request.id_quote_request.padStart(6, '0')}</h3>
                          ...
                          <td>
                            <div className="qr_action_block_wrapper">
                              <button className="button-blue outline" onClick={this.confirmQuote.bind(this,request.id_quote_request, request.quantity, i)}>
                                <span>Quote</span>
                              </button>
                ...
                <tr className="no-results-wrapper"><td colSpan="3"><div className="no-results"><img src="../supplier/src/assets/img/no-data.png" alt="No Results"/><h2>No Quotations Found!</h2><p>There is no quotations.<br/> please contact your Relationship Manager for any issues</p></div></td><td></td></tr>
              }
              </InfiniteScroll>
          </table>
        </div>
