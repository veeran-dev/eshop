        ...
        return (
           <div className="feedback">
            <div className="page-header">
              <button className="back" onClick={this.props.history.goBack.bind(this)}>
                ...
                <div className="feedback-question">
                  ...
                  <div className="feedback-options">
                    <a className="happy" href="javascript:void(0)" onClick={this.successFeedback.bind(this)}>
                      <img src="src/assets/img/smiles/happy.png" alt="happy"/>
                    ...
                    <a className="sad" href="javascript:void(0)" onClick={this.unsuccessFeedback.bind(this)}>
                      <img src="src/assets/img/smiles/sad.png" alt="sad" />
