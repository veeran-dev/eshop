...
*/
	...
	public function hookTop($params)
	{
		...
		if($context->controller->php_self=='index')
			Media::addJsDef(array('blocksearch_type' => 'home'));
		else
	...
	public function getCategory()
	{
		$sql='SELECT kc.`id_category`,kcl.`name` FROM `'._DB_PREFIX_.'category` kc
				...
				WHERE kcl.`id_lang`=1
				AND kc.`id_parent`=1 and kc.active = 1 and kc.`id_category` not in(41200445,41200435,41200425,41200213,41200075,208615)';
