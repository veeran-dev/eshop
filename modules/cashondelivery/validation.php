...
if (Tools::getValue('confirm'))
{
	...
	/*if($customer->verification_status != 2) // Check if the customer is verified or not
		$this->module->validateOrder((int)$cart->id, Configuration::get('PS_OS_CUSTOMER_VERIFICATION_PENDING'), $total, $this->module->displayName, NULL, array(), NULL, false, $customer->secure_key);
	else*/
	$this->module->validateOrder((int)$cart->id, Configuration::get('PS_OS_ORDERPLACED'), $total, $this->module->displayName, NULL, array(), NULL, false, $customer->secure_key);
