...
{if count($categoryProducts) > 0 && $categoryProducts !== false}
	<div id="productscategory_list">
		<h3 class="productscategory_h3">{if count($categoryProducts) > 1}{l s='Similar Products' mod='productscategory'}{else}{l s='Similar Product' mod='productscategory'}{/if}</h3>
		<ul>
