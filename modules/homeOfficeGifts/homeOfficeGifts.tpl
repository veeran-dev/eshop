<!-- <script type="text/javascript" src="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}modules/homeOfficeGifts/homeOfficeGifts.js"></script> -->
			
<!-- MODULE Home Featured Products -->
{if isset($products) AND $products}
<div class="homecarouseldiv">
<br />
<h4>{l s='Corporate Gifts' mod='homeOfficeGifts'}
	<span>
	<khelp class="khelp">Beautiful & useful Gifts for your employees and clients.</khelp>
	<a href="https://www.kobster.com/139-corporate-gifts">View All &gt;&gt;</a>
	</span>
</h4>
<div class="homecarouselulwrapper">
<ul id="homecarouselelulgi">
	{foreach from=$products item=product name=officeSta}
		...
		<li onmouseover="document.getElementById('button_gi_{$product.id_product}').style.visibility = 'visible';"
			onmouseout="document.getElementById('button_gi_{$product.id_product}').style.visibility = 'hidden';">
		...
		<a onClick="return false;" href="#gi_qvb_{$product.id_product}" class="quickViewButton" id="button_gi_{$product.id_product}"><img src="https://www.kobster.com/images/quickView.jpg"/></a>
...
<!-- <a id="prev5" class="prev" href="#"><img src="https://www.kobster.com/themes/theme335/img/prev.png" atl="&lt;"/></a>
<a id="next5" class="next" href="#"><img src="https://www.kobster.com/themes/theme335/img/next.png" atl="&gt;"/></a> -->
</div>
{else}
...
<div id="gi_qvb_{$product.id_product}" class="quickView">
		<a onClick="return false;" class="quickViewClose" href="#gi_qvb_{$product.id_product}"><img src="https://www.kobster.com/images/Close.png" /></a>
                 ...
                 <div id="price_div" style="width:50%">
                 	 <div id="mrp_div" >
                        ...
                        {if isset($product.show_price) && $product.show_price && !isset($restricted_country_mode)}
                            ...
                            <span class="quick_price">{if !$priceDisplay}{convertPrice price=$product.price}{else}{convertPrice price=$product.price_tax_exc}{/if}</span>
                            </div>
                        {/if}
                    </div>
