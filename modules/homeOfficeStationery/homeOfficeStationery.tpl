<script type="text/javascript" src="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}modules/homeOfficeStationery/homeOfficeStationery.js"></script>
<!-- MODULE Home Featured Products -->
<!--m{if isset($products) AND $products}
--><div id="officestationery-div">
<!--<h4>
...
-->
	<span id="images">
		<img  class="dummy" id="os-img" src="http://localhost/kobstereshop/img/Stationery-modify-mahesh1.png" />
     	<div class="os-visual-cue" id="circle-cue-img-punching-machine" ></div>
        <div class="os-visual-cue" id="circle-cue-img-calc"></div>
        <div class="os-visual-cue" id="circle-cue-img-pencil"></div>
        <div class="os-visual-cue" id="circle-cue-img-memo-pad"></div>
        <div class="os-visual-cue" id="circle-cue-img-pen-stand" ></div>
        <div class="os-visual-cue" id="circle-cue-img-scissor"></div>
    </span>   
     
     <span id="right-side-div" class="dummy">
     <div id="os-heading">OFFICE STATIONERY</div>
     <div id="pencil-div">
     <a class="image-category"  href=	"http://localhost/kobstereshop/category.php?id_category=2"
          																				 target="_blank">			
	 <span class="right-side-align" id="pen"> &#10004;&nbsp;Penstand</span>
      </a>
     <a class="image-category"  href=	"http://localhost/kobstereshop/category.php?id_category=2"
          																				 target="_blank">			
	 
     <span class="right-side-align" id="pencil"> &#10004;&nbsp;Pencil</span>
     </a>
     </div>
     <div id="scissor-div">
     <a class="image-category"  href=	"http://localhost/kobstereshop/category.php?id_category=2"
          																				 target="_blank">			
	 <span class="right-side-align" id="scissor">&#10004;&nbsp;Scissor</span>
     </a>
     <a class="image-category" href="http://localhost/kobstereshop/category.php?id_category=2"
          																				 target="_blank">			
	 
     <span class="right-side-align" id="stabler">&#10004;&nbsp;Stabler</span>
     </a>
     </div>
     
     <div id="go-to" class="dummy"><a id="a-go-to" href="http://localhost/kobstereshop/category.php?id_category=2"
          																				 target="_blank">			
	 GO TO STORE >> </a></div>
     ...
     <div id="circle-cue-img-punching-machine-div" class="hidden-div-styles">
     <span  class="types">
     <a class="product_text"  href=	"http://localhost/kobstereshop/233--paper-punches#/" target="_blank">			
     <p class="hidden-div-font">Punching machine starting from </p>
     <p class="centre">Rs.58</p>
     </span>
     </a> 
     </div>

    <div id="circle-cue-img-calc-div"  class="hidden-div-styles">
    <span  class="types">
     <a class="product_text"  href=	"http://localhost/kobstereshop/274-calculators#/" target="_blank">			
     <p class="hidden-div-font">Calculator starting from </p>
     <p class="centre">Rs.110</p>
     </span>
     </a> 
     </div>

    <div id="circle-cue-img-pencil-div"  class="hidden-div-styles">
    <span  class="types">
     <a class="product_text"  href=	"http://localhost/kobstereshop/109-pen-holder#/" target="_blank">			
     <p class="hidden-div-font">Pen and pencil starting from </p>
     <p class="centre">Rs.3</p>
     </span>
     </a>      
     </div>

    <div id="circle-cue-img-memo-pad-div"  class="hidden-div-styles">
    <span  class="types">
     <a class="product_text"  href=	"http://localhost/kobstereshop/279-memo-pads#/" target="_blank">			
     <p class="hidden-div-font">Memo pads starting from </p>
     <p class="centre">Rs.12</p>
     </span>
     </a> 
     </div>

     
     <div id="circle-cue-img-pen-stand-div" class="hidden-div-styles">
     <span  class="types">
     <a class="product_text"  href=	"http://localhost/kobstereshop/109-pen-holder#/" target="_blank">			
     <p class="hidden-div-font">Pen Stand starting from </p>
     <p class="centre">Rs.63</p>
     </span>
     </a> 
     </div>
	...
	<div id="circle-cue-img-scissor-div"  class="hidden-div-styles">
    <span  class="types">
     <a class="product_text"  href=	"http://localhost/kobstereshop/166-scissors#/" target="_blank">			
     <p class="hidden-div-font">Scissor starting from</p>
     <p class="centre">Rs.17</p>
     </span>
     </a> 
    </div>
        ...
        <!--<div id="pencil-div"><span>d</span><span></span><span></span></div>
    	<div id="calc-div"><span>da</span><span></span><span></span></div>
    	<div id="scissor-div"><span>dsds</span><span></span><span></span></div>
    	<div id="stabler-div"><span></span>adsdsa<span></span><span></span></div>
    -->
