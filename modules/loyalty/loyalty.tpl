...
<ul class="footer_links">
	...
	<li><a href="{$base_dir}"><img src="{$img_dir}icon/home.gif" alt="" class="icon" /></a><a {$isPerks == 1} href="{$base_dir}perksDeals" {else} href="{$base_dir}" {/if}>{l s='Home' mod='loyalty'}</a></li>
</ul>
