...
<ul class="footer_links">
	...
	<li class="f_right">
		<a {if $isPerks == 1} href="{$base_dir}perksDeals" {else} href="{$base_dir}" {/if} title="{l s='Home' mod='loyalty'}"><img src="{$img_dir}icon/home.gif" alt="" class="icon" /></a>
		<a {if $isPerks == 1} href="{$base_dir}perksDeals" {else} href="{$base_dir}" {/if} title="{l s='Home' mod='loyalty'}">{l s='Home' mod='loyalty'}</a>
	</li>
</ul>
