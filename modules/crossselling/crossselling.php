    ...
    protected function getOrderProducts(array $products_id)
    {
        ...
        if (count($orders) > 0) {
            ...
            foreach ($order_products as &$order_product) {
                ...
                $order_product['ratings'] = ProductComment::getAverageGrade($order_product['id_product']);
                $order_product['nbComments'] = (int)(ProductComment::getCommentNumber($order_product['id_product']));
