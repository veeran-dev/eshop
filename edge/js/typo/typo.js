...
var Typo = function (dictionary, affData, wordsData) {
	...
	if (dictionary) {
		...
		if (this.platform == "chrome") {
			if (!affData) affData = this._readFile("https://www.kobster.com/dict/en_US/" + dictionary + ".aff");
			if (!wordsData) wordsData = this._readFile("https://www.kobster.com/dict/en_US/" + dictionary + ".dic");
		}
