...
var Typo = function (dictionary, affData, wordsData) {
	...
	if (dictionary) {
		...
		if (this.platform == "chrome") {
			if (!affData) affData = this._readFile(chrome.extension.getURL("http:/localhost/kobstereshop/edge/js/typo/dictionaries/" + dictionary + "/" + dictionary + ".aff"));
			if (!wordsData) wordsData = this._readFile(chrome.extension.getURL("http:/localhost/kobstereshop/edge/js/typo/dictionaries/" + dictionary + "/" + dictionary + ".dic"));
			alert("http:/localhost/kobstereshop/edge/js/typo/dictionaries/" + dictionary + "/" + dictionary + ".aff");
		}
