...
/*Table structure for table `kob_notification_subject` */

DROP TABLE IF EXISTS `kob_notification_subject`;

CREATE TABLE `kob_notification_subject` (
  `id_subject_type` int(20) NOT NULL AUTO_INCREMENT,
